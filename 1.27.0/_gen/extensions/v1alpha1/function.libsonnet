{
  ...
  '#':: d.pkg(name='function', url='', help='"TriggerMesh Function."'),
  ...
  '#spec':: d.obj(help='"Desired state of the function."'),
  spec: {
    ...
    '#ceOverrides':: d.obj(help='"Defines overrides to control modifications of the event attributes."'),
    ceOverrides: {
    ...
    '#eventStore':: d.obj(help='"EventStore service connection string."'),
    eventStore: {
      '#withUri':: d.fn(help='', args=[d.arg(name='uri', type=d.T.string)]),
      withUri(uri): { spec+: { eventStore+: { uri: uri } } },
    },
    ...
    '#withCode':: d.fn(help='"Function code."', args=[d.arg(name='code', type=d.T.string)]),
    withCode(code): { spec+: { code: code } },
    '#withEntrypoint':: d.fn(help='"Function name to use as an entrypoint."', args=[d.arg(name='entrypoint', type=d.T.string)]),
    withEntrypoint(entrypoint): { spec+: { entrypoint: entrypoint } },
    '#withResponseIsEvent':: d.fn(help='"Whether function responds with CE payload only or with full event."', args=[d.arg(name='responseIsEvent', type=d.T.boolean)]),
    withResponseIsEvent(responseIsEvent): { spec+: { responseIsEvent: responseIsEvent } },
    '#withRuntime':: d.fn(help='"Function runtime name. Python, Ruby or Node runtimes are currently supported."', args=[d.arg(name='runtime', type=d.T.string)]),
