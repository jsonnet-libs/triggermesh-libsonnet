{
  ...
  '#':: d.pkg(name='jqTransformation', url='', help='"TriggerMesh CloudEvents JSON Query Transformation engine."'),
  ...
  '#new':: d.fn(help='new returns an instance of JQTransformation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'flow.triggermesh.io/v1alpha1',
    kind: 'JQTransformation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Desired state of the transformer."'),
  spec: {
    ...
    '#withQuery':: d.fn(help='"The JSON Query to perform on the incoming event"', args=[d.arg(name='query', type=d.T.string)]),
