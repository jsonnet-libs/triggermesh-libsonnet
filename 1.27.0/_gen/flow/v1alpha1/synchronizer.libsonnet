{
  ...
  '#':: d.pkg(name='synchronizer', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of Synchronizer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'flow.triggermesh.io/v1alpha1',
    kind: 'Synchronizer',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Desired state of the event synchronizer."'),
  spec: {
    ...
    '#correlationKey':: d.obj(help='"Events correlation parameters."'),
    correlationKey: {
      '#withAttribute':: d.fn(help='"The name of the correlation key that will be injected into the CloudEvents context. Events without this attribute are forwarded to the Sink as the client requests while client connections are held open. Events, which context already has the correlation key, are sent back to the open client connections."', args=[d.arg(name='attribute', type=d.T.string)]),
      withAttribute(attribute): { spec+: { correlationKey+: { attribute: attribute } } },
      '#withLength':: d.fn(help='"The length of the correlation key to generate. The default value is 24."', args=[d.arg(name='length', type=d.T.integer)]),
      withLength(length): { spec+: { correlationKey+: { length: length } } },
    },
    '#response':: d.obj(help='"Responses handling configuration."'),
    response: {
      '#withTimeout':: d.fn(help='"The time during which the synchronizer will block the client and wait for the response. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration."', args=[d.arg(name='timeout', type=d.T.string)]),
      withTimeout(timeout): { spec+: { response+: { timeout: timeout } } },
    },
    '#sink':: d.obj(help='"The destination where the synchronizer will forward incoming requests from the clients."'),
    sink: {
