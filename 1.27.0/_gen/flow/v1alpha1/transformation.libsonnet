{
  ...
  '#':: d.pkg(name='transformation', url='', help='"TriggerMesh CloudEvents transformation engine. Allows to declaratively perform data transformations on CloudEvents."'),
  ...
  '#new':: d.fn(help='new returns an instance of Transformation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'flow.triggermesh.io/v1alpha1',
    kind: 'Transformation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Desired state of the transformation object."'),
  spec: {
    ...
    '#context':: d.obj(help='"CloudEvents Context attributes transformation spec."'),
    context: {
      '#paths':: d.obj(help='"Key-value event pairs to apply the transformations on."'),
      paths: {
        '#withKey':: d.fn(help='"JSON path or variable name. Depends on the operation type."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { key: key },
        '#withSeparator':: d.fn(help='"JSON path separator symbol. \\".\\" is used by default."', args=[d.arg(name='separator', type=d.T.string)]),
        withSeparator(separator): { separator: separator },
        '#withValue':: d.fn(help='"JSON path or variable name. Depends on the operation type."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withOperation':: d.fn(help='"Name of the transformation operation."', args=[d.arg(name='operation', type=d.T.string)]),
      withOperation(operation): { operation: operation },
      '#withPaths':: d.fn(help='"Key-value event pairs to apply the transformations on."', args=[d.arg(name='paths', type=d.T.array)]),
      withPaths(paths): { paths: if std.isArray(v=paths) then paths else [paths] },
      '#withPathsMixin':: d.fn(help='"Key-value event pairs to apply the transformations on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='paths', type=d.T.array)]),
      withPathsMixin(paths): { paths+: if std.isArray(v=paths) then paths else [paths] },
    },
    '#data':: d.obj(help='"CloudEvents Data transformation spec."'),
    data: {
      '#paths':: d.obj(help='"Key-value event pairs to apply the transformations on."'),
      paths: {
        '#withKey':: d.fn(help='"JSON path or variable name. Depends on the operation type."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#sink':: d.obj(help='"The destination of events emitted by the component. If left empty, the events will be sent back to the sender."'),
    sink: {
