{
  ...
  '#':: d.pkg(name='xmlToJSONTransformation', url='', help='"TriggerMesh CloudEvents XML to JSON Transformation engine."'),
  ...
  '#new':: d.fn(help='new returns an instance of XMLToJSONTransformation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
