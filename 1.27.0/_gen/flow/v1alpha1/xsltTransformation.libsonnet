{
  ...
  '#':: d.pkg(name='xsltTransformation', url='', help='"TriggerMesh CloudEvents XSLT transformation."'),
  ...
  '#new':: d.fn(help='new returns an instance of XSLTTransformation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'flow.triggermesh.io/v1alpha1',
    kind: 'XSLTTransformation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Desired state of the TriggerMesh component."'),
  spec: {
    ...
    '#withAllowPerEventXSLT':: d.fn(help='"Whether the XSLT informed at the spec can be overriden at each CloudEvent."', args=[d.arg(name='allowPerEventXSLT', type=d.T.boolean)]),
    withAllowPerEventXSLT(allowPerEventXSLT): { spec+: { allowPerEventXSLT: allowPerEventXSLT } },
    '#xslt':: d.obj(help='"XSLT used to transform incoming CloudEvents."'),
    xslt: {
      '#valueFromConfigMap':: d.obj(help='"A reference to a Kubernetes ConfigMap object containing the value."'),
      valueFromConfigMap: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { xslt+: { valueFromConfigMap+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { xslt+: { valueFromConfigMap+: { name: name } } } },
      },
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the value."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { xslt+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { xslt+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal inline value."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { xslt+: { value: value } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
