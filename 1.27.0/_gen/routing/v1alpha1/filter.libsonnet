{
  ...
  '#':: d.pkg(name='filter', url='', help='"TriggerMesh content-based events filter."'),
  ...
  '#spec':: d.obj(help='"Desired state of the filter."'),
  spec: {
    ...
    '#withExpression':: d.fn(help='"Google CEL-like expression string."', args=[d.arg(name='expression', type=d.T.string)]),
    withExpression(expression): { spec+: { expression: expression } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
