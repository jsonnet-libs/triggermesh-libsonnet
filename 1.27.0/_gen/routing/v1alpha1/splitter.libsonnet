{
  ...
  '#':: d.pkg(name='splitter', url='', help='"TriggerMesh content-based events splitter."'),
  ...
  '#new':: d.fn(help='new returns an instance of Splitter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'routing.triggermesh.io/v1alpha1',
    kind: 'Splitter',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Desired state of the splitter."'),
  spec: {
    ...
    '#ceContext':: d.obj(help='"Context attributes to set on produced CloudEvents."'),
    ceContext: {
      '#withExtensions':: d.fn(help='"Additional context extensions to set on produced CloudEvents."', args=[d.arg(name='extensions', type=d.T.object)]),
      withExtensions(extensions): { spec+: { ceContext+: { extensions: extensions } } },
      '#withExtensionsMixin':: d.fn(help='"Additional context extensions to set on produced CloudEvents."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extensions', type=d.T.object)]),
      withExtensionsMixin(extensions): { spec+: { ceContext+: { extensions+: extensions } } },
      '#withSource':: d.fn(help='"CloudEvent \\"source\\" context attribute. Accepts a JSONPath expressions in brackets (e.g. \\"user/{.name}\\")."', args=[d.arg(name='source', type=d.T.string)]),
      withSource(source): { spec+: { ceContext+: { source: source } } },
      '#withType':: d.fn(help='"CloudEvent \\"type\\" context attribute."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { ceContext+: { type: type } } },
    },
    ...
    '#withPath':: d.fn(help='"JSONPath expression representing the key containing the data array to split. Defaults to the root."', args=[d.arg(name='path', type=d.T.string)]),
