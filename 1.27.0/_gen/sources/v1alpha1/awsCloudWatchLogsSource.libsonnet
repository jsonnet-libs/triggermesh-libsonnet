{
  ...
  '#':: d.pkg(name='awsCloudWatchLogsSource', url='', help='"TriggerMesh event source for Amazon CloudWatch Logs."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSCloudWatchLogsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon CloudWatch Logs API."'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events generated from Amazon CloudWatch Logs."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Log Group to source data from. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoncloudwatchlogs.html#amazoncloudwatchlogs-resources-for-iam-policies"', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withPollingInterval':: d.fn(help='"Duration which defines how often logs should be pulled from Amazon CloudWatch Logs. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration. Defaults to 5m"', args=[d.arg(name='pollingInterval', type=d.T.string)]),
