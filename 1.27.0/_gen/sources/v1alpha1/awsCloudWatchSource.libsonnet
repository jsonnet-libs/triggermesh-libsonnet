{
  ...
  '#':: d.pkg(name='awsCloudWatchSource', url='', help='"TriggerMesh event source for Amazon CloudWatch."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSCloudWatchSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon CloudWatch API."'),
    auth: {
    ...
    metricQueries: {
      ...
      metric: {
        ...
        metric: {
          ...
          withDimensions(dimensions): { metric+: { metric+: { dimensions: if std.isArray(v=dimensions) then dimensions else [dimensions] } } },
          ...
          withDimensionsMixin(dimensions): { metric+: { metric+: { dimensions+: if std.isArray(v=dimensions) then dimensions else [dimensions] } } },
          '#withMetricName':: d.fn(help='"Name of the metric."', args=[d.arg(name='metricName', type=d.T.string)]),
          withMetricName(metricName): { metric+: { metric+: { metricName: metricName } } },
          '#withNamespace':: d.fn(help='"Namespace of the metric."', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { metric+: { metric+: { namespace: namespace } } },
        },
        '#withPeriod':: d.fn(help='"The granularity, in seconds, of the returned data points."', args=[d.arg(name='period', type=d.T.integer)]),
        withPeriod(period): { metric+: { period: period } },
        '#withStat':: d.fn(help='"The statistic to return."', args=[d.arg(name='stat', type=d.T.string)]),
        withStat(stat): { metric+: { stat: stat } },
        '#withUnit':: d.fn(help='"If specified, return only data with that unit."', args=[d.arg(name='unit', type=d.T.string)]),
        withUnit(unit): { metric+: { unit: unit } },
      },
      '#withExpression':: d.fn(help="\"Math expression to be performed on the metric data. Mutually exclusive with 'metric'.\"", args=[d.arg(name='expression', type=d.T.string)]),
      withExpression(expression): { expression: expression },
      '#withName':: d.fn(help='"Unique short name that identifies the query."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    '#sink':: d.obj(help='"The destination of events generated from Amazon CloudWatch metrics."'),
    sink: {
    ...
    '#withMetricQueries':: d.fn(help='"List of queries that determine what metrics will be sourced from Amazon CloudWatch. Each item represents an individual MetricDataQuery. For more information, please refer to the CloudWatch API reference at https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_MetricDataQuery.html"', args=[d.arg(name='metricQueries', type=d.T.array)]),
    withMetricQueries(metricQueries): { spec+: { metricQueries: if std.isArray(v=metricQueries) then metricQueries else [metricQueries] } },
    '#withMetricQueriesMixin':: d.fn(help='"List of queries that determine what metrics will be sourced from Amazon CloudWatch. Each item represents an individual MetricDataQuery. For more information, please refer to the CloudWatch API reference at https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_MetricDataQuery.html"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metricQueries', type=d.T.array)]),
    withMetricQueriesMixin(metricQueries): { spec+: { metricQueries+: if std.isArray(v=metricQueries) then metricQueries else [metricQueries] } },
    '#withPollingInterval':: d.fn(help='"Duration which defines how often metrics should be pulled from Amazon CloudWatch. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration. Defaults to 5m"', args=[d.arg(name='pollingInterval', type=d.T.string)]),
    withPollingInterval(pollingInterval): { spec+: { pollingInterval: pollingInterval } },
    '#withRegion':: d.fn(help='"Code of the AWS region to source metrics from. Available region codes are documented in the AWS General Reference at https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints."', args=[d.arg(name='region', type=d.T.string)]),
