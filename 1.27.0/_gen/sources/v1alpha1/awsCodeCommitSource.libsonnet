{
  ...
  '#':: d.pkg(name='awsCodeCommitSource', url='', help='"TriggerMesh event source for Amazon CodeCommit."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSCodeCommitSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon CodeCommit API."'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Amazon CodeCommit."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the CodeCommit repository to receive events from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscodecommit.html#awscodecommit-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withBranch':: d.fn(help='"Name of the Git branch this source observes."', args=[d.arg(name='branch', type=d.T.string)]),
    withBranch(branch): { spec+: { branch: branch } },
    '#withEventTypes':: d.fn(help='"List of event types that should be processed by the source."', args=[d.arg(name='eventTypes', type=d.T.array)]),
    withEventTypes(eventTypes): { spec+: { eventTypes: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } },
    '#withEventTypesMixin':: d.fn(help='"List of event types that should be processed by the source."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypes', type=d.T.array)]),
