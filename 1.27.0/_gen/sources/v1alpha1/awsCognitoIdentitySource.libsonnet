{
  ...
  '#':: d.pkg(name='awsCognitoIdentitySource', url='', help='"TriggerMesh event source for Amazon Cognito Identity Pool."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSCognitoIdentitySource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon Cognito API."'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from the Amazon Cognito Identity Pool."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Amazon Cognito Identity Pool to receive notifications from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazoncognitoidentity.html#amazoncognitoidentity-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
