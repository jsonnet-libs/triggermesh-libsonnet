{
  ...
  '#':: d.pkg(name='awsCognitoUserPoolSource', url='', help='"TriggerMesh event source for Amazon Cognito User Pool."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSCognitoUserPoolSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from the Amazon Cognito User Pool."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Amazon Cognito User Pool to receive notifications from. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoncognitouserpools.html#amazoncognitouserpools-resources-for-iam-policies"', args=[d.arg(name='arn', type=d.T.string)]),
