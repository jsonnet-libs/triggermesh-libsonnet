{
  ...
  '#':: d.pkg(name='awsDynamoDBSource', url='', help='"TriggerMesh event source for Amazon DynamoDB."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSDynamoDBSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon DynamoDB API."'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Amazon DynamoDB."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the DynamoDB table to receive modification events from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazondynamodb.html#amazondynamodb-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
