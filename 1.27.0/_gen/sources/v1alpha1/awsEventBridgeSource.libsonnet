{
  ...
  '#':: d.pkg(name='awsEventBridgeSource', url='', help='"TriggerMesh event source for Amazon EventBridge."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSEventBridgeSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon EventBridge and SQS APIs."'),
    auth: {
    ...
    '#destination':: d.obj(help='"The intermediate destination of notifications originating from the Amazon EventBridge event bus, before they are retrieved by this event source. If omitted, an Amazon SQS queue is automatically created and associated with the EventBridge event rule."'),
    destination: {
      '#sqs':: d.obj(help="\"Properties of an Amazon SQS queue to use as intermediate destination for the event bus' events.\""),
      sqs: {
        '#withQueueARN':: d.fn(help="\"ARN of the Amazon SQS queue that should be receiving event bus' events. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonsqs.html#amazonsqs-resources-for-iam-policies.\"", args=[d.arg(name='queueARN', type=d.T.string)]),
        withQueueARN(queueARN): { spec+: { destination+: { sqs+: { queueARN: queueARN } } } },
      },
    },
    '#sink':: d.obj(help='"The destination of events sourced from Amazon EventBridge."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Amazon EventBridge event bus to subscribe to. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoneventbridge.html#amazoneventbridge-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withEventPattern':: d.fn(help='"Event pattern used to select events that this source should subscribe to. If not specified, the event rule is created with a catch-all pattern. More information in the user guide for Amazon EventBridge at https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-event-patterns.html"', args=[d.arg(name='eventPattern', type=d.T.string)]),
    withEventPattern(eventPattern): { spec+: { eventPattern: eventPattern } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
