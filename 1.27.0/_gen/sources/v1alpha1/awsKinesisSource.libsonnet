{
  ...
  '#':: d.pkg(name='awsKinesisSource', url='', help='"TriggerMesh event source for Amazon Kinesis."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSKinesisSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon Kinesis API."'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Amazon Kinesis."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Kinesis stream to receive data from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonkinesis.html#amazonkinesis-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
