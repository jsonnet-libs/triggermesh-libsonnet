{
  ...
  '#':: d.pkg(name='awsPerformanceInsightsSource', url='', help='"TriggerMesh event source for Amazon RDS Performance Insights."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSPerformanceInsightsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon RDS and Performance Insights APIs."'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events generated by Amazon Performance Insights."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Amazon RDS database instance to receive metrics for. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonrds.html#amazonrds-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withMetrics':: d.fn(help="\"List of metrics to retrieve from Amazon Performance Insights. Each item represents the 'metric' attribute of a MetricQuery. For more information, please refer to the Performance Insights API reference at https://docs.aws.amazon.com/performance-insights/latest/APIReference/API_MetricQuery.html.\"", args=[d.arg(name='metrics', type=d.T.array)]),
    withMetrics(metrics): { spec+: { metrics: if std.isArray(v=metrics) then metrics else [metrics] } },
    '#withMetricsMixin':: d.fn(help="\"List of metrics to retrieve from Amazon Performance Insights. Each item represents the 'metric' attribute of a MetricQuery. For more information, please refer to the Performance Insights API reference at https://docs.aws.amazon.com/performance-insights/latest/APIReference/API_MetricQuery.html.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='metrics', type=d.T.array)]),
    withMetricsMixin(metrics): { spec+: { metrics+: if std.isArray(v=metrics) then metrics else [metrics] } },
    '#withPollingInterval':: d.fn(help='"Duration which defines how often metrics should be pulled from Amazon Performance Insights. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration."', args=[d.arg(name='pollingInterval', type=d.T.string)]),
