{
  ...
  '#':: d.pkg(name='awss3Source', url='', help='"TriggerMesh event source for Amazon S3."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSS3Source', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon S3 and SQS APIs."'),
    auth: {
    ...
    '#destination':: d.obj(help='"The intermediate destination of notifications originating from the Amazon S3 bucket, before they are retrieved by this event source. If omitted, an Amazon SQS queue is automatically created and associated with the bucket."'),
    destination: {
      '#sqs':: d.obj(help='"Properties of an Amazon SQS queue to use as intermediate destination for bucket notifications."'),
      sqs: {
        '#withQueueARN':: d.fn(help='"ARN of the Amazon SQS queue that should be receiving bucket notifications. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonsqs.html#amazonsqs-resources-for-iam-policies."', args=[d.arg(name='queueARN', type=d.T.string)]),
        withQueueARN(queueARN): { spec+: { destination+: { sqs+: { queueARN: queueARN } } } },
      },
    },
    '#sink':: d.obj(help='"The destination of events sourced from Amazon S3."'),
    sink: {
    ...
    '#withArn':: d.fn(help="\"ARN of the Amazon S3 bucket to receive notifications from. The expected format is documented at\\nhttps://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html#amazons3-resources-for-iam-policies.\\n\\nAlthough not technically supported by S3, the ARN provided via this attribute may include a region and\\nan account ID. When this information is provided, it is used to set an accurate identity-based access\\npolicy between the S3 bucket and the reconciled SQS queue, unless an existing queue is provided via\\nthe 'destination.sqs.queueARN' attribute.\"", args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withEventTypes':: d.fn(help='"List of event types that the source should subscribe to. Accepted values are listed at https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-event-types-and-destinations.html."', args=[d.arg(name='eventTypes', type=d.T.array)]),
    withEventTypes(eventTypes): { spec+: { eventTypes: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } },
    '#withEventTypesMixin':: d.fn(help='"List of event types that the source should subscribe to. Accepted values are listed at https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-event-types-and-destinations.html."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypes', type=d.T.array)]),
