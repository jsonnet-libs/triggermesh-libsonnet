{
  ...
  '#':: d.pkg(name='awssqsSource', url='', help='"TriggerMesh event source for Amazon SQS."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSSQSSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Amazon SQS API."'),
    auth: {
    ...
    '#endpoint':: d.obj(help='"Customizations of the AWS REST API endpoint."'),
    endpoint: {
      '#withUrl':: d.fn(help='"URL of the endpoint."', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { endpoint+: { url: url } } },
    },
    '#receiveOptions':: d.obj(help='"Options that control the behavior of message receivers."'),
    receiveOptions: {
      '#withVisibilityTimeout':: d.fn(help='"Period of time during which Amazon SQS prevents other consumers from receiving and processing a message that has been received via ReceiveMessage. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration. If not defined, the overall visibility timeout for the queue is used. For more details, please refer to the Amazon SQS Developer Guide at https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html."', args=[d.arg(name='visibilityTimeout', type=d.T.string)]),
      withVisibilityTimeout(visibilityTimeout): { spec+: { receiveOptions+: { visibilityTimeout: visibilityTimeout } } },
    },
    '#sink':: d.obj(help='"The destination of events sourced from Amazon SQS."'),
    sink: {
    ...
    '#withArn':: d.fn(help='"ARN of the Amazon SQS queue to consume messages from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonsqs.html#amazonsqs-resources-for-iam-policies."', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withMessageProcessor':: d.fn(help='"Name of the message processor to use for converting SQS messages to CloudEvents. Supported values are \\"default\\", \\"s3\\", and \\"eventbridge\\"."', args=[d.arg(name='messageProcessor', type=d.T.string)]),
    withMessageProcessor(messageProcessor): { spec+: { messageProcessor: messageProcessor } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
