{
  ...
  '#':: d.pkg(name='azureActivityLogsSource', url='', help='"TriggerMesh event source for Azure Activity Logs."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureActivityLogsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Monitor REST API. This event source only supports the Service Principal authentication. If it not present, it will try to use Azure AKS Managed Identity"'),
    auth: {
    ...
    '#ceOverrides':: d.obj(help=''),
    ceOverrides: {
      '#withExtensions':: d.fn(help='', args=[d.arg(name='extensions', type=d.T.object)]),
      withExtensions(extensions): { spec+: { ceOverrides+: { extensions: extensions } } },
      '#withExtensionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extensions', type=d.T.object)]),
      withExtensionsMixin(extensions): { spec+: { ceOverrides+: { extensions+: extensions } } },
    },
    '#destination':: d.obj(help='"The intermediate destination of activity logs, before they are retrieved by this event source."'),
    destination: {
      '#eventHubs':: d.obj(help='"Properties of an Event Hubs namespace to use as intermediate destination of activity logs."'),
      eventHubs: {
        '#withConsumerGroup':: d.fn(help='"A view (state, position, or offset) of an entire event hub. Consumer groups enable consuming applications to each have a separate view of the event stream. They read the stream independently at their own pace and with their own offsets. For more information about Event Hubs Consumer Groups, please refer to https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-features#consumer-groups."', args=[d.arg(name='consumerGroup', type=d.T.string)]),
        withConsumerGroup(consumerGroup): { spec+: { destination+: { eventHubs+: { consumerGroup: consumerGroup } } } },
        '#withHubName':: d.fn(help="\"Name of the Event Hubs instance within the selected namespace. If omitted, Azure automatically creates an Event Hub with the name 'insights-activity-logs' inside the selected namespace.\"", args=[d.arg(name='hubName', type=d.T.string)]),
        withHubName(hubName): { spec+: { destination+: { eventHubs+: { hubName: hubName } } } },
        '#withNamespaceID':: d.fn(help='"Resource ID of the Event Hubs namespace.\\n\\nThe expected format is\\n  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}"', args=[d.arg(name='namespaceID', type=d.T.string)]),
        withNamespaceID(namespaceID): { spec+: { destination+: { eventHubs+: { namespaceID: namespaceID } } } },
        '#withSasPolicy':: d.fn(help="\"Name of a SAS policy with Manage permissions inside the Event Hubs namespace referenced by the 'namespaceID' field. Defaults to 'RootManageSharedAccessKey'.\"", args=[d.arg(name='sasPolicy', type=d.T.string)]),
        withSasPolicy(sasPolicy): { spec+: { destination+: { eventHubs+: { sasPolicy: sasPolicy } } } },
      },
    },
    '#sink':: d.obj(help='"The destination of events sourced from Azure Activity Logs."'),
    sink: {
    ...
    '#withCategories':: d.fn(help='"Categories of Activity Logs to collect. All available categories are selected when this attribute is empty. For a list of available Activity Logs category, please refer to https://docs.microsoft.com/en-us/azure/azure-monitor/platform/activity-log-schema#categories."', args=[d.arg(name='categories', type=d.T.array)]),
    withCategories(categories): { spec+: { categories: if std.isArray(v=categories) then categories else [categories] } },
    '#withCategoriesMixin':: d.fn(help='"Categories of Activity Logs to collect. All available categories are selected when this attribute is empty. For a list of available Activity Logs category, please refer to https://docs.microsoft.com/en-us/azure/azure-monitor/platform/activity-log-schema#categories."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='categories', type=d.T.array)]),
    withCategoriesMixin(categories): { spec+: { categories+: if std.isArray(v=categories) then categories else [categories] } },
    '#withSubscriptionID':: d.fn(help='"The ID of the Azure subscription which activity logs to subscribe to."', args=[d.arg(name='subscriptionID', type=d.T.string)]),
    withSubscriptionID(subscriptionID): { spec+: { subscriptionID: subscriptionID } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
