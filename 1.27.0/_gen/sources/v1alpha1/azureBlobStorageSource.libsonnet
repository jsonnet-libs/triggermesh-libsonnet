{
  ...
  '#':: d.pkg(name='azureBlobStorageSource', url='', help='"TriggerMesh event source for Azure Blob Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureBlobStorageSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Storage and Azure Event Hubs REST APIs. This event source only supports the Service Principal authentication. If it not present, it will try to use Azure AKS Managed Identity"'),
    auth: {
    ...
    '#endpoint':: d.obj(help='"The intermediate destination of events subscribed via Event Grid, before they are retrieved by this event source."'),
    endpoint: {
      '#eventHubs':: d.obj(help='"Properties of an Event Hubs namespace to use as intermediate destination of events."'),
      eventHubs: {
        ...
        withConsumerGroup(consumerGroup): { spec+: { endpoint+: { eventHubs+: { consumerGroup: consumerGroup } } } },
        '#withHubName':: d.fn(help='"Name of the Event Hubs instance within the selected namespace. If omitted, an Event Hubs instance is created on behalf of the user."', args=[d.arg(name='hubName', type=d.T.string)]),
        withHubName(hubName): { spec+: { endpoint+: { eventHubs+: { hubName: hubName } } } },
        ...
        withNamespaceID(namespaceID): { spec+: { endpoint+: { eventHubs+: { namespaceID: namespaceID } } } },
      },
    },
    '#sink':: d.obj(help='"The destination of events sourced from Azure Storage."'),
    sink: {
    ...
    '#withEventTypes':: d.fn(help='"Types of events to subscribe to.\\n\\nThe list of available event types can be found at\\nhttps://docs.microsoft.com/en-us/azure/event-grid/event-schema-blob-storage.\\n\\nWhen this attribute is not set, the source automatically subscribes to the following event types\\n- Microsoft.Storage.BlobCreated\\n- Microsoft.Storage.BlobDeleted"', args=[d.arg(name='eventTypes', type=d.T.array)]),
    withEventTypes(eventTypes): { spec+: { eventTypes: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } },
    '#withEventTypesMixin':: d.fn(help='"Types of events to subscribe to.\\n\\nThe list of available event types can be found at\\nhttps://docs.microsoft.com/en-us/azure/event-grid/event-schema-blob-storage.\\n\\nWhen this attribute is not set, the source automatically subscribes to the following event types\\n- Microsoft.Storage.BlobCreated\\n- Microsoft.Storage.BlobDeleted"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypes', type=d.T.array)]),
    withEventTypesMixin(eventTypes): { spec+: { eventTypes+: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } },
    '#withStorageAccountID':: d.fn(help='"Resource ID of the Storage Account to receive events for.\\n\\nThe accepted format is\\n  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{storageAccountName}\\n\\nBesides the Storage Account name itself, the resource ID contains the subscription ID and resource\\ngroup name which all together uniquely identify the Storage Account within Azure."', args=[d.arg(name='storageAccountID', type=d.T.string)]),
    withStorageAccountID(storageAccountID): { spec+: { storageAccountID: storageAccountID } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
