{
  ...
  '#':: d.pkg(name='azureEventGridSource', url='', help='"TriggerMesh event source for Azure Event Grid."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureEventGridSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Event Grid and Azure Event Hubs REST APIs. This event source only supports the Service Principal authentication. If it not present, it will try to use Azure AKS Managed Identity"'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Azure Event Grid."'),
    sink: {
    ...
    '#withScope':: d.fn(help='"The resource ID the event subscription applies to.\\n\\nCan be\\n- an Azure subscription\\n  /subscriptions/{subscriptionId}\\n- a resource group\\n  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}\\n- a top-level resource from a resource provider (including Event Grid topic)\\n  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"', args=[d.arg(name='scope', type=d.T.string)]),
