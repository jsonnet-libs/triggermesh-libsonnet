{
  ...
  '#':: d.pkg(name='azureEventHubsSource', url='', help='"TriggerMesh event source for Azure Event Hubs."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureEventHubsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Event Hubs REST API. If it not present, it will try to use Azure AKS Managed Identity"'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Azure Event Hubs."'),
    sink: {
    ...
    '#withConsumerGroup':: d.fn(help='"A view (state, position, or offset) of an entire event hub. Consumer groups enable consuming applications to each have a separate view of the event stream. They read the stream independently at their own pace and with their own offsets. For more information about Event Hubs components, please refer to https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-about#key-architecture-components"', args=[d.arg(name='consumerGroup', type=d.T.string)]),
    withConsumerGroup(consumerGroup): { spec+: { consumerGroup: consumerGroup } },
    ...
    '#withMessageCountSize':: d.fn(help='"The number of messages to receive from the Event Hub at a time."', args=[d.arg(name='messageCountSize', type=d.T.integer)]),
    withMessageCountSize(messageCountSize): { spec+: { messageCountSize: messageCountSize } },
    '#withMessageTimeout':: d.fn(help='"The timeout in seconds to wait for the number of messages to be available in the Event Hub before."', args=[d.arg(name='messageTimeout', type=d.T.integer)]),
    withMessageTimeout(messageTimeout): { spec+: { messageTimeout: messageTimeout } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
