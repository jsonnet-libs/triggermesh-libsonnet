{
  ...
  '#':: d.pkg(name='azureIOTHubSource', url='', help='"TriggerMesh event source for Azure IOT Hub."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureIOTHubSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure IOT Hub."'),
    auth: {
      '#sasToken':: d.obj(help='"An Azure shared access signature (SAS) token. For more information about SAS tokens, please refer to the Azure IOT Hub documentation at https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-dev-guide-sas?tabs=node."'),
      sasToken: {
        '#connectionString':: d.obj(help='"Connection string containing both the resource URI of the IOT Hub Bus instance, and the SAS token."'),
        connectionString: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Azure IOT Hub."'),
    sink: {
