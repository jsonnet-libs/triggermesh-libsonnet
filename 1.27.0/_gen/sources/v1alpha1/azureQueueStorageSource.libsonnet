{
  ...
  '#':: d.pkg(name='azureQueueStorageSource', url='', help='"TriggerMesh event source for Azure Queue Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureQueueStorageSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    '#accountKey':: d.obj(help='"A storage account access key for authenticating against the Azure Storage REST API."'),
    accountKey: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the account key."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { accountKey+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { accountKey+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the account key."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { accountKey+: { value: value } } },
    },
    ...
    '#withAccountName':: d.fn(help='"Name of the storage account."', args=[d.arg(name='accountName', type=d.T.string)]),
    withAccountName(accountName): { spec+: { accountName: accountName } },
    '#withQueueName':: d.fn(help='"Name of the queue."', args=[d.arg(name='queueName', type=d.T.string)]),
    withQueueName(queueName): { spec+: { queueName: queueName } },
    '#withVisibilityTimeout':: d.fn(help="\"Specifies the new visibility timeout value, in seconds, relative to server time. The new value must be larger than or equal to 0, and can't be larger than 7 days. The visibility timeout of a message can't be set to a value later than the expiry time. You can update a message until it has been deleted or has expired. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration. Default 20s.\"", args=[d.arg(name='visibilityTimeout', type=d.T.string)]),
    withVisibilityTimeout(visibilityTimeout): { spec+: { visibilityTimeout: visibilityTimeout } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
