{
  ...
  '#':: d.pkg(name='azureServiceBusQueueSource', url='', help='"TriggerMesh event source for Azure Service Bus Queue."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureServiceBusQueueSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Service Bus Queue. If it not present, it will try to use Azure AKS Managed Identity"'),
    auth: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Azure Service Bus Queue."'),
    sink: {
