{
  ...
  '#':: d.pkg(name='azureServiceBusSource', url='', help='"TriggerMesh event source for Azure Service Bus."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureServiceBusSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Service Bus API. This event source only supports the Service Principal authentication. If it not present, it will try to use Azure AKS Managed Identity"'),
    auth: {
      '#sasToken':: d.obj(help='"An Azure shared access signature (SAS) token. For more information about SAS tokens, please refer to the Azure Service Bus Queue documentation at https://docs.microsoft.com/en-us/azure/service-bus-messaging/service-bus-sas."'),
      sasToken: {
        '#connectionString':: d.obj(help="\"Connection string containing both the resource URI of the Service Bus Queue, and the SAS token. Mutually exclusive with 'keyName' and 'keyValue'.\""),
        connectionString: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from the Azure Service Bus."'),
    sink: {
    ...
    '#withMaxConcurrent':: d.fn(help='"maximum number of goroutines that will be used to process messages. default 10."', args=[d.arg(name='maxConcurrent', type=d.T.integer)]),
    withMaxConcurrent(maxConcurrent): { spec+: { maxConcurrent: maxConcurrent } },
    '#withQueueID':: d.fn(help='"The resource ID the Service Bus Queue to subscribe to.\\n\\nThe expected format is\\n  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}"', args=[d.arg(name='queueID', type=d.T.string)]),
    withQueueID(queueID): { spec+: { queueID: queueID } },
    '#withTopicID':: d.fn(help='"The resource ID the Service Bus Topic to subscribe to.\\n\\nThe expected format is\\n  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}"', args=[d.arg(name='topicID', type=d.T.string)]),
    withTopicID(topicID): { spec+: { topicID: topicID } },
    '#withWebSocketsEnable':: d.fn(help='"Boolean to indicate to use WebSockets."', args=[d.arg(name='webSocketsEnable', type=d.T.boolean)]),
    withWebSocketsEnable(webSocketsEnable): { spec+: { webSocketsEnable: webSocketsEnable } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
