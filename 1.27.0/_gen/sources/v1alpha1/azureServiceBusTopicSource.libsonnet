{
  ...
  '#':: d.pkg(name='azureServiceBusTopicSource', url='', help='"TriggerMesh event source for Azure Service Bus Topics."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureServiceBusTopicSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from the Azure Service Bus Topic."'),
    sink: {
