{
  ...
  '#':: d.pkg(name='cloudEventsSource', url='', help='"TriggerMesh event source for receiving arbitrary CloudEvents over HTTP."'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudEventsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sources.triggermesh.io/v1alpha1',
    kind: 'CloudEventsSource',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Specification for the CloudEvents source."'),
  spec: {
    ...
    '#ceOverrides':: d.obj(help='"Defines overrides/additions to incoming CloudEvents attributes."'),
    ceOverrides: {
      '#extensions':: d.obj(help=''),
      extensions: {
        '#withSource':: d.fn(help='', args=[d.arg(name='source', type=d.T.string)]),
        withSource(source): { spec+: { ceOverrides+: { extensions+: { source: source } } } },
        '#withSubject':: d.fn(help='', args=[d.arg(name='subject', type=d.T.string)]),
        withSubject(subject): { spec+: { ceOverrides+: { extensions+: { subject: subject } } } },
        '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { ceOverrides+: { extensions+: { type: type } } } },
      },
    },
    '#credentials':: d.obj(help='"Optional credentials specification for incoming requests."'),
    credentials: {
      '#basicAuths':: d.obj(help='"Array of HTTP basic authentication parameters, all present usernames and passwords are considered valid."'),
      basicAuths: {
        '#password':: d.obj(help='"Password for HTTP Basic authentication."'),
        password: {
          ...
          valueFromSecret: {
            ...
            withKey(key): { password+: { valueFromSecret+: { key: key } } },
            '#withName':: d.fn(help='"Name of the Secret object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { password+: { valueFromSecret+: { name: name } } },
          },
        },
        '#withUsername':: d.fn(help='"User name for HTTP Basic authentication."', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { username: username },
      },
      '#withBasicAuths':: d.fn(help='"Array of HTTP basic authentication parameters, all present usernames and passwords are considered valid."', args=[d.arg(name='basicAuths', type=d.T.array)]),
      withBasicAuths(basicAuths): { spec+: { credentials+: { basicAuths: if std.isArray(v=basicAuths) then basicAuths else [basicAuths] } } },
      '#withBasicAuthsMixin':: d.fn(help='"Array of HTTP basic authentication parameters, all present usernames and passwords are considered valid."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='basicAuths', type=d.T.array)]),
      withBasicAuthsMixin(basicAuths): { spec+: { credentials+: { basicAuths+: if std.isArray(v=basicAuths) then basicAuths else [basicAuths] } } },
    },
    '#rateLimiter':: d.obj(help='"Rate limiter provides a mechanism to reject incoming requests when a threshold is trespassed, informing the caller to retry later."'),
    rateLimiter: {
      '#withRequestsPerSecond':: d.fn(help='"Number of requests accepted per time duration."', args=[d.arg(name='requestsPerSecond', type=d.T.integer)]),
      withRequestsPerSecond(requestsPerSecond): { spec+: { rateLimiter+: { requestsPerSecond: requestsPerSecond } } },
    },
    '#sink':: d.obj(help='"The destination of events generated from requests to the source."'),
    sink: {
    ...
    '#withPath':: d.fn(help='"Path where incoming CloudEvents will be accepted."', args=[d.arg(name='path', type=d.T.string)]),
