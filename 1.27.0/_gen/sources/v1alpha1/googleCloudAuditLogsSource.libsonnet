{
  ...
  '#':: d.pkg(name='googleCloudAuditLogsSource', url='', help='"TriggerMesh event source for Google Cloud Audit Logs."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudAuditLogsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication options for Google Cloud Platform API."'),
    auth: {
    ...
    '#pubsub':: d.obj(help='"Attributes related to the configuration of Pub/Sub resources associated with the Cloud Audit Log."'),
    pubsub: {
      '#withProject':: d.fn(help="\"Name of the GCP project where Pub/Sub resources associated with the Cloud Audit log sink are to be created. Mutually exclusive with 'topic' which, if supplied, already contains the project name.\"", args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { pubsub+: { project: project } } },
      '#withTopic':: d.fn(help="\"Full resource name of the Pub/Sub topic where change notifications originating from the configured audit logs sink are sent to, before being retrieved by this event source. If not supplied, a topic is created on behalf of the user, in the GCP project referenced by the 'project' attribute. The expected format is described at https://cloud.google.com/pubsub/docs/admin#resource_names\"", args=[d.arg(name='topic', type=d.T.string)]),
    ...
    '#withMethodName':: d.fn(help='"The name of the service method or operation. For API calls, this should be the name of the API method. For example, \\"google.pubsub.v1.Publisher.CreateTopic\\"."', args=[d.arg(name='methodName', type=d.T.string)]),
    withMethodName(methodName): { spec+: { methodName: methodName } },
    '#withResourceName':: d.fn(help='"The resource or collection that is the target of the operation. The name is a scheme-less URI, not including the API service name. https://cloud.google.com/logging/docs/reference/audit/auditlog/rest/Shared.Types/AuditLog"', args=[d.arg(name='resourceName', type=d.T.string)]),
    withResourceName(resourceName): { spec+: { resourceName: resourceName } },
    '#withServiceName':: d.fn(help='"The name of the API service performing the operation. For example, \\"pubsub.googleapis.com\\"."', args=[d.arg(name='serviceName', type=d.T.string)]),
