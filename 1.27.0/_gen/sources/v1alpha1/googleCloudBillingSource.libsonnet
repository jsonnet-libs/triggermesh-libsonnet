{
  ...
  '#':: d.pkg(name='googleCloudBillingSource', url='', help='"TriggerMesh event source for Google Cloud Billing."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudBillingSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#pubsub':: d.obj(help='"Attributes related to the configuration of Pub/Sub resources associated with the Cloud Billing."'),
    pubsub: {
      '#withProject':: d.fn(help="\"Name of the GCP project where Pub/Sub resources associated with the Cloud Billing are to be created. Mutually exclusive with 'topic' which, if supplied, already contains the project name.\"", args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { pubsub+: { project: project } } },
      '#withTopic':: d.fn(help="\"Full resource name of the Pub/Sub topic where notifications originating from the configured billing budget are sent to, before being retrieved by this event source. If not supplied, a topic is created on behalf of the user, in the GCP project referenced by the 'project' attribute. The expected format is described at https://cloud.google.com/pubsub/docs/admin#resource_names.\"", args=[d.arg(name='topic', type=d.T.string)]),
    ...
    '#withBillingAccountId':: d.fn(help='"The identifier for the Cloud Billing account owning the budget. Example, 01D4EE-079462-DFD6EC."', args=[d.arg(name='billingAccountId', type=d.T.string)]),
    withBillingAccountId(billingAccountId): { spec+: { billingAccountId: billingAccountId } },
    '#withBudgetId':: d.fn(help="\"The identifier for the Cloud Billing budget. You can locate the budget's ID in your budget under Manage notifications. The ID is displayed after you select Connect a Pub/Sub topic to this budget. Example, de72f49d-779b-4945-a127-4d6ce8def0bb.\"", args=[d.arg(name='budgetId', type=d.T.string)]),
    withBudgetId(budgetId): { spec+: { budgetId: budgetId } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
