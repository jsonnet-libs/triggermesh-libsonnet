{
  ...
  '#':: d.pkg(name='googleCloudPubSubSource', url='', help='"TriggerMesh event source for Google Cloud Pub/Sub."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudPubSubSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withSubscriptionID':: d.fn(help='"ID of the subscription to use to pull messages from the topic. If supplied, this subscription must 1) exist and 2) belong to the provided topic. Otherwise, a pull subscription to that topic is created on behalf of the user."', args=[d.arg(name='subscriptionID', type=d.T.string)]),
    withSubscriptionID(subscriptionID): { spec+: { subscriptionID: subscriptionID } },
    '#withTopic':: d.fn(help='"Full resource name of the Pub/Sub topic to subscribe to, in the format \\"projects/{project_name}/topics/{topic_name}\\"."', args=[d.arg(name='topic', type=d.T.string)]),
