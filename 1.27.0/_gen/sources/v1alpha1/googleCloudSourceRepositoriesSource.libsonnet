{
  ...
  '#':: d.pkg(name='googleCloudSourceRepositoriesSource', url='', help='"TriggerMesh event source for Google Cloud Source Repositories."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudSourceRepositoriesSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#pubsub':: d.obj(help='"Attributes related to the configuration of Pub/Sub resources associated with the Cloud Repositories."'),
    pubsub: {
      '#withTopic':: d.fn(help="\"Full resource name of the Pub/Sub topic where change notifications originating from the configured repo are sent to, before being retrieved by this event source. If not supplied, a topic is created on behalf of the user, in the GCP project referenced by the 'project' attribute. The expected format is described at https://cloud.google.com/pubsub/docs/admin#resource_names\"", args=[d.arg(name='topic', type=d.T.string)]),
    ...
    '#withPublishServiceAccount':: d.fn(help="\"Email address of the service account used for publishing notifications to Pub/Sub. This service\\naccount needs to be in the same project as the repo, and to have the 'pubsub.topics.publish' IAM\\npermission associated with it. It can (but doesn't have to) be the same service account as the\\n'serviceAccountKey' attribute.\\n\\nIf unspecified, it defaults to the Compute Engine default service account.\"", args=[d.arg(name='publishServiceAccount', type=d.T.string)]),
    withPublishServiceAccount(publishServiceAccount): { spec+: { publishServiceAccount: publishServiceAccount } },
    '#withRepository':: d.fn(help='"Full resource name of the Repository."', args=[d.arg(name='repository', type=d.T.string)]),
    withRepository(repository): { spec+: { repository: repository } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
