{
  ...
  '#':: d.pkg(name='googleCloudStorageSource', url='', help='"TriggerMesh event source for Google Cloud Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudStorageSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help=''),
    auth: {
      '#serviceAccountKey':: d.obj(help='"Service account key used to authenticate the event source and allow it to interact with Google Cloud APIs. Only the JSON format is supported."'),
      serviceAccountKey: {
        '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the service account key."'),
        valueFromSecret: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { auth+: { serviceAccountKey+: { valueFromSecret+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { auth+: { serviceAccountKey+: { valueFromSecret+: { name: name } } } } },
        },
        '#withValue':: d.fn(help='"Literal value of the service account key."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { spec+: { auth+: { serviceAccountKey+: { value: value } } } },
      },
      '#withGcpServiceAccount':: d.fn(help='"GCP Service account name to impersonate Identity and Access Management (IAM) service accounts to access Google Cloud services. For the GKE platform only. More details about workload identity at https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity"', args=[d.arg(name='gcpServiceAccount', type=d.T.string)]),
      withGcpServiceAccount(gcpServiceAccount): { spec+: { auth+: { gcpServiceAccount: gcpServiceAccount } } },
      '#withKubernetesServiceAccount':: d.fn(help='"The name of the Kubernetes Service account that will be annotated with the gcpServiceAccount identity. If the service account already exists it will be assigned to the receive adapter, otherwise controller will create it. Optional, by default the Kubernetes service account will be generated by the controller."', args=[d.arg(name='kubernetesServiceAccount', type=d.T.string)]),
      withKubernetesServiceAccount(kubernetesServiceAccount): { spec+: { auth+: { kubernetesServiceAccount: kubernetesServiceAccount } } },
    },
    '#pubsub':: d.obj(help='"Attributes related to the configuration of Pub/Sub resources associated with the Cloud Storage bucket."'),
    pubsub: {
      '#withProject':: d.fn(help="\"Name of the GCP project where Pub/Sub resources associated with the Cloud Storage bucket are to be created. Mutually exclusive with 'topic' which, if supplied, already contains the project name.\"", args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { pubsub+: { project: project } } },
      '#withTopic':: d.fn(help="\"Full resource name of the Pub/Sub topic where change notifications originating from the configured bucket are sent to, before being retrieved by this event source. If not supplied, a topic is created on behalf of the user, in the GCP project referenced by the 'project' attribute. The expected format is described at https://cloud.google.com/pubsub/docs/admin#resource_names\"", args=[d.arg(name='topic', type=d.T.string)]),
      withTopic(topic): { spec+: { pubsub+: { topic: topic } } },
    },
    '#sink':: d.obj(help='"The destination of events received via change notifications."'),
    sink: {
    ...
    '#withBucket':: d.fn(help='"Name of the Cloud Storage bucket to receive change notifications from. Must meet the naming requirements described at https://cloud.google.com/storage/docs/naming-buckets"', args=[d.arg(name='bucket', type=d.T.string)]),
    withBucket(bucket): { spec+: { bucket: bucket } },
    '#withEventTypes':: d.fn(help='"Types of events to receive change notifications for. Accepted values are listed at https://cloud.google.com/storage/docs/pubsub-notifications#events. All types are selected when this attribute is not set."', args=[d.arg(name='eventTypes', type=d.T.array)]),
    withEventTypes(eventTypes): { spec+: { eventTypes: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } },
    '#withEventTypesMixin':: d.fn(help='"Types of events to receive change notifications for. Accepted values are listed at https://cloud.google.com/storage/docs/pubsub-notifications#events. All types are selected when this attribute is not set."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypes', type=d.T.array)]),
    withEventTypesMixin(eventTypes): { spec+: { eventTypes+: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } },
    '#withObjectNamePrefix':: d.fn(help='"If present, will only receive notifications for objects whose names that begin with this prefix."', args=[d.arg(name='objectNamePrefix', type=d.T.string)]),
    withObjectNamePrefix(objectNamePrefix): { spec+: { objectNamePrefix: objectNamePrefix } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
