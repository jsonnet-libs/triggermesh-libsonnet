{
  ...
  '#':: d.pkg(name='httpPollerSource', url='', help='"TriggerMesh event source for sourcing events by polling HTTP/S endpoints."'),
  ...
  '#new':: d.fn(help='new returns an instance of HTTPPollerSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#basicAuthPassword':: d.obj(help='"Password to set in HTTP requests that require HTTP Basic authentication."'),
    basicAuthPassword: {
    ...
    '#sink':: d.obj(help='"The destination of events generated by polling the HTTP/S endpoint."'),
    sink: {
    ...
    '#withBasicAuthUsername':: d.fn(help='"User name to set in HTTP requests that require HTTP Basic authentication."', args=[d.arg(name='basicAuthUsername', type=d.T.string)]),
    withBasicAuthUsername(basicAuthUsername): { spec+: { basicAuthUsername: basicAuthUsername } },
    '#withCaCertificate':: d.fn(help='"CA certificate in X.509 format the HTTP client should use to verify the identity of remote servers when communicating over TLS."', args=[d.arg(name='caCertificate', type=d.T.string)]),
    withCaCertificate(caCertificate): { spec+: { caCertificate: caCertificate } },
    '#withEndpoint':: d.fn(help='"HTTP/S URL of the endpoint to poll data from."', args=[d.arg(name='endpoint', type=d.T.string)]),
    ...
    '#withHeaders':: d.fn(help='"HTTP headers to include in HTTP requests sent to the endpoint."', args=[d.arg(name='headers', type=d.T.object)]),
    withHeaders(headers): { spec+: { headers: headers } },
    '#withHeadersMixin':: d.fn(help='"HTTP headers to include in HTTP requests sent to the endpoint."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.object)]),
    withHeadersMixin(headers): { spec+: { headers+: headers } },
    '#withInterval':: d.fn(help='"Duration which defines how often the HTTP/S endpoint should be polled. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration."', args=[d.arg(name='interval', type=d.T.string)]),
    withInterval(interval): { spec+: { interval: interval } },
    '#withMethod':: d.fn(help="\"HTTP request method to use in requests to the specified 'endpoint'.\"", args=[d.arg(name='method', type=d.T.string)]),
    withMethod(method): { spec+: { method: method } },
    '#withSkipVerify':: d.fn(help="\"Controls whether the HTTP client verifies the server's certificate chain and host name when communicating over TLS.\"", args=[d.arg(name='skipVerify', type=d.T.boolean)]),
