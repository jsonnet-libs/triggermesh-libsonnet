{
  ...
  '#':: d.pkg(name='kafkaSource', url='', help='"TriggerMesh event source for Kafka."'),
  ...
  '#new':: d.fn(help='new returns an instance of KafkaSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    auth: {
      ...
      kerberos: {
        ...
        '#withRealm':: d.fn(help='"The name of the Kerberos Realm."', args=[d.arg(name='realm', type=d.T.string)]),
      ...
      '#password':: d.obj(help='"Kafka account password."'),
      password: {
        '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the password."'),
        valueFromSecret: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
      ...
      tls: {
        ...
        ca: {
          '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the CA content."'),
          valueFromSecret: {
            '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#clientCert':: d.obj(help='"The value of the Client Cert."'),
        clientCert: {
        ...
        '#clientKey':: d.obj(help='"The value of the Client Key."'),
        clientKey: {
      ...
      '#withUsername':: d.fn(help='"Kafka account username."', args=[d.arg(name='username', type=d.T.string)]),
      withUsername(username): { spec+: { auth+: { username: username } } },
    },
    '#sink':: d.obj(help='"The destination of events sourced from Kafka Kafka."'),
    sink: {
    ...
    '#withGroupID':: d.fn(help='"The ID of the kafka group."', args=[d.arg(name='groupID', type=d.T.string)]),
    withGroupID(groupID): { spec+: { groupID: groupID } },
