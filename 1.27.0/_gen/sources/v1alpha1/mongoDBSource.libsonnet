{
  ...
  '#':: d.pkg(name='mongoDBSource', url='', help='"TriggerMesh event source for MongoDB."'),
  ...
  '#new':: d.fn(help='new returns an instance of MongoDBSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withCollection':: d.fn(help='"MongoDB collection name."', args=[d.arg(name='collection', type=d.T.string)]),
    withCollection(collection): { spec+: { collection: collection } },
    '#withConnectionString':: d.fn(help='"MongoDB connection string."', args=[d.arg(name='connectionString', type=d.T.string)]),
    withConnectionString(connectionString): { spec+: { connectionString: connectionString } },
    '#withDatabase':: d.fn(help='"MongoDB database name."', args=[d.arg(name='database', type=d.T.string)]),
