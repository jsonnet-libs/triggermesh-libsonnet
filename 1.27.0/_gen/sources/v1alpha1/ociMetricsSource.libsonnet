{
  ...
  '#':: d.pkg(name='ociMetricsSource', url='', help='"TriggerMesh event source for Oracle Cloud Infrastructure (OCI) Metrics."'),
  ...
  '#new':: d.fn(help='new returns an instance of OCIMetricsSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#metrics':: d.obj(help='"Array of metrics to poll for."'),
    metrics: {
      '#withMetricsNamespace':: d.fn(help='"Type of metrics to pull from such as oci_computeagent, oci_apigateway, oci_vnc, or oci_compute_infrastructure_health."', args=[d.arg(name='metricsNamespace', type=d.T.string)]),
      withMetricsNamespace(metricsNamespace): { metricsNamespace: metricsNamespace },
      '#withMetricsQuery':: d.fn(help='"Metrics query to send based off of OCI Monitoring Query Language."', args=[d.arg(name='metricsQuery', type=d.T.string)]),
      withMetricsQuery(metricsQuery): { metricsQuery: metricsQuery },
      '#withName':: d.fn(help='"Used as the event source for the metric."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withOracleCompartment':: d.fn(help="\"OCID of the target compartment (if not specified, default to the value of 'oracleTenancy').\"", args=[d.arg(name='oracleCompartment', type=d.T.string)]),
      withOracleCompartment(oracleCompartment): { oracleCompartment: oracleCompartment },
    },
    '#oracleApiPrivateKey':: d.obj(help='"PEM encoded API private key that has access to the OCI metrics API."'),
    oracleApiPrivateKey: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret containing the private key."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oracleApiPrivateKey+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oracleApiPrivateKey+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the private key."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { oracleApiPrivateKey+: { value: value } } },
    },
    '#oracleApiPrivateKeyFingerprint':: d.obj(help="\"MD5 fingerprint of 'oracleApiPrivateKey'.\""),
    oracleApiPrivateKeyFingerprint: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret containing the fingerprint."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oracleApiPrivateKeyFingerprint+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oracleApiPrivateKeyFingerprint+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the fingerprint."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { oracleApiPrivateKeyFingerprint+: { value: value } } },
    },
    '#oracleApiPrivateKeyPassphrase':: d.obj(help="\"Passphrase to unlock the 'oracleApiPrivateKey'.\""),
    oracleApiPrivateKeyPassphrase: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret containing the passphrase."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oracleApiPrivateKeyPassphrase+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oracleApiPrivateKeyPassphrase+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the passphrase."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { oracleApiPrivateKeyPassphrase+: { value: value } } },
    },
    '#sink':: d.obj(help='"The destination of events sourced from OCI metrics."'),
    sink: {
    ...
    '#withMetrics':: d.fn(help='"Array of metrics to poll for."', args=[d.arg(name='metrics', type=d.T.array)]),
    withMetrics(metrics): { spec+: { metrics: if std.isArray(v=metrics) then metrics else [metrics] } },
    '#withMetricsMixin':: d.fn(help='"Array of metrics to poll for."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metrics', type=d.T.array)]),
    withMetricsMixin(metrics): { spec+: { metrics+: if std.isArray(v=metrics) then metrics else [metrics] } },
    '#withMetricsPollingFrequency':: d.fn(help='"Polling frequency of the OCI API for metrics details (supported values 1m-60m, 1h-24h, 1d)."', args=[d.arg(name='metricsPollingFrequency', type=d.T.string)]),
    withMetricsPollingFrequency(metricsPollingFrequency): { spec+: { metricsPollingFrequency: metricsPollingFrequency } },
    '#withOracleRegion':: d.fn(help='"OCI target region."', args=[d.arg(name='oracleRegion', type=d.T.string)]),
    withOracleRegion(oracleRegion): { spec+: { oracleRegion: oracleRegion } },
    '#withOracleTenancy':: d.fn(help='"OCID of the target tenancy."', args=[d.arg(name='oracleTenancy', type=d.T.string)]),
    withOracleTenancy(oracleTenancy): { spec+: { oracleTenancy: oracleTenancy } },
    '#withOracleUser':: d.fn(help="\"OCID of the target user associated with the 'oracleApiPrivateKey'.\"", args=[d.arg(name='oracleUser', type=d.T.string)]),
    withOracleUser(oracleUser): { spec+: { oracleUser: oracleUser } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
