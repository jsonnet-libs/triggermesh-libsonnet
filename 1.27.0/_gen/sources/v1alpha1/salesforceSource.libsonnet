{
  ...
  '#':: d.pkg(name='salesforceSource', url='', help='"TriggerMesh event source for Salesforce."'),
  ...
  '#new':: d.fn(help='new returns an instance of SalesforceSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Salesforce API."'),
    auth: {
      '#certKey':: d.obj(help='"Certificate key to sign authentication requests with the Salesforce API."'),
      certKey: {
        '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret containing the certificate key."'),
        valueFromSecret: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { auth+: { certKey+: { valueFromSecret+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { auth+: { certKey+: { valueFromSecret+: { name: name } } } } },
        },
        '#withValue':: d.fn(help='"Literal value of the certificate key."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { spec+: { auth+: { certKey+: { value: value } } } },
      },
      '#withClientID':: d.fn(help='"Client ID."', args=[d.arg(name='clientID', type=d.T.string)]),
      withClientID(clientID): { spec+: { auth+: { clientID: clientID } } },
      '#withServer':: d.fn(help='"Salesforce server."', args=[d.arg(name='server', type=d.T.string)]),
      withServer(server): { spec+: { auth+: { server: server } } },
      '#withUser':: d.fn(help='"Salesforce user."', args=[d.arg(name='user', type=d.T.string)]),
      withUser(user): { spec+: { auth+: { user: user } } },
    },
    '#sink':: d.obj(help='"The destination of events received via Salesforce streams."'),
    sink: {
    ...
    '#subscription':: d.obj(help='"Subscription to a Salesforce channel."'),
    subscription: {
      '#withChannel':: d.fn(help='', args=[d.arg(name='channel', type=d.T.string)]),
      withChannel(channel): { spec+: { subscription+: { channel: channel } } },
      '#withReplayID':: d.fn(help='', args=[d.arg(name='replayID', type=d.T.integer)]),
      withReplayID(replayID): { spec+: { subscription+: { replayID: replayID } } },
    },
    '#withApiVersion':: d.fn(help='"Salesforce API version."', args=[d.arg(name='apiVersion', type=d.T.string)]),
