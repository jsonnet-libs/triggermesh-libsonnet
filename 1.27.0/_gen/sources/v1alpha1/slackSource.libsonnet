{
  ...
  '#':: d.pkg(name='slackSource', url='', help='"TriggerMesh event source for Slack."'),
  ...
  '#new':: d.fn(help='new returns an instance of SlackSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#signingSecret':: d.obj(help='"Signing secret to authenticate Slack callbacks."'),
    signingSecret: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret containing the signing secret."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='"Key from the Secret object."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { signingSecret+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the Secret object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { signingSecret+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the signing secret."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { signingSecret+: { value: value } } },
    },
    '#sink':: d.obj(help='"The destination of events generated from Slack callbacks."'),
    sink: {
    ...
    '#withAppID':: d.fn(help='"ID which identifies the Slack application generating this event. It helps identifying the App that sources events when multiple Slack applications share the same endpoint."', args=[d.arg(name='appID', type=d.T.string)]),
    withAppID(appID): { spec+: { appID: appID } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
