{
  ...
  '#':: d.pkg(name='solaceSource', url='', help='"TriggerMesh event source for Solace."'),
  ...
  '#new':: d.fn(help='new returns an instance of SolaceSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#sink':: d.obj(help='"The destination of events sourced from Solace."'),
    sink: {
