{
  ...
  '#':: d.pkg(name='twilioSource', url='', help='"TriggerMesh event source for Twilio."'),
  ...
  '#new':: d.fn(help='new returns an instance of TwilioSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#sink':: d.obj(help='"The destination of events received by the webhook."'),
    sink: {
