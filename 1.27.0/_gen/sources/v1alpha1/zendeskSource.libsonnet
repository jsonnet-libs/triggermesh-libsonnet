{
  ...
  '#':: d.pkg(name='zendeskSource', url='', help='"TriggerMesh event source for Zendesk."'),
  ...
  '#new':: d.fn(help='new returns an instance of ZendeskSource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#sink':: d.obj(help='"The destination of events generated from requests to the Zendesk webhook."'),
    sink: {
    ...
    '#token':: d.obj(help='"Zendesk API token. Allows the source to interact with the Zendesk API."'),
    token: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret containing the API token."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='"Key from the Secret object."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { token+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the Secret object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { token+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the API token."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { token+: { value: value } } },
    },
    '#webhookPassword':: d.obj(help='"Password Zendesk requests must set to authenticate with the webhook using HTTP Basic authentication."'),
    webhookPassword: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the password."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='"Key from the Secret object."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { webhookPassword+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the Secret object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { webhookPassword+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the password."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { webhookPassword+: { value: value } } },
    },
    '#withEmail':: d.fn(help='"Email of the Zendesk user to authenticate requests to the Zendesk API."', args=[d.arg(name='email', type=d.T.string)]),
    withEmail(email): { spec+: { email: email } },
    '#withSubdomain':: d.fn(help='"Name of the Zendesk subdomain."', args=[d.arg(name='subdomain', type=d.T.string)]),
    withSubdomain(subdomain): { spec+: { subdomain: subdomain } },
    '#withWebhookUsername':: d.fn(help='"User name Zendesk requests must set to authenticate with the webhook using HTTP Basic authentication."', args=[d.arg(name='webhookUsername', type=d.T.string)]),
    withWebhookUsername(webhookUsername): { spec+: { webhookUsername: webhookUsername } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
