{
  ...
  '#':: d.pkg(name='awsComprehendTarget', url='', help='"An event targte for sending messages to the AWS Comprehend API."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSComprehendTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withLanguage':: d.fn(help='"Language code to use for Comprehend. Available languages can be found at https://docs.aws.amazon.com/comprehend/latest/dg/supported-languages.html."', args=[d.arg(name='language', type=d.T.string)]),
    withLanguage(language): { spec+: { language: language } },
    '#withRegion':: d.fn(help='"Code of the AWS region to use for the Comprehend API. Available region codes are documented in the AWS General Reference at https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints."', args=[d.arg(name='region', type=d.T.string)]),
