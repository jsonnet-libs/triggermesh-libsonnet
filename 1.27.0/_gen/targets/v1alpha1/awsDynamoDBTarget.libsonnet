{
  ...
  '#':: d.pkg(name='awsDynamoDBTarget', url='', help='"TriggerMesh event target for AWS DynamoDB."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSDynamoDBTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withArn':: d.fn(help='"ARN of the DynamoDB table to post events to. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazondynamodb.html"', args=[d.arg(name='arn', type=d.T.string)]),
