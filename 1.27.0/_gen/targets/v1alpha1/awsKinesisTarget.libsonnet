{
  ...
  '#':: d.pkg(name='awsKinesisTarget', url='', help='"An event target that can stream events into an AWS Kinesis stream."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSKinesisTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withArn':: d.fn(help='"ARN of the Kinesis stream that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonkinesis.html"', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in records created in Kinesis. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
    withDiscardCloudEventContext(discardCloudEventContext): { spec+: { discardCloudEventContext: discardCloudEventContext } },
    '#withPartition':: d.fn(help='"A Kinesis partition name is required for the target to know where to stream the events to."', args=[d.arg(name='partition', type=d.T.string)]),
