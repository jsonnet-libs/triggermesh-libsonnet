{
  ...
  '#':: d.pkg(name='awss3Target', url='', help='"An event target that can stream events into an AWS S3 bucket."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSS3Target', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withArn':: d.fn(help='"ARN of the S3 bucket that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html"', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in objects created in S3. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
