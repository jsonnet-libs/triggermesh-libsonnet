{
  ...
  '#':: d.pkg(name='awssqsTarget', url='', help='"TriggerMesh event target for AWS Simple Queue Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSSQSTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withArn':: d.fn(help='"ARN of the SQS queue that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_awslambda.html"', args=[d.arg(name='arn', type=d.T.string)]),
    withArn(arn): { spec+: { arn: arn } },
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in messages sent to SQS. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
    withDiscardCloudEventContext(discardCloudEventContext): { spec+: { discardCloudEventContext: discardCloudEventContext } },
    '#withMessageGroupId':: d.fn(help='"FIFO queue grouping to ensure proper ordering. Should be unique per target"', args=[d.arg(name='messageGroupId', type=d.T.string)]),
    withMessageGroupId(messageGroupId): { spec+: { messageGroupId: messageGroupId } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
