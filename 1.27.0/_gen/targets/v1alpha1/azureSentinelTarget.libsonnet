{
  ...
  '#':: d.pkg(name='azureSentinelTarget', url='', help='"TriggerMesh event target for azuresentineltarget."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureSentinelTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withResourceGroup':: d.fn(help='"resourceGroup refers to the resource group where the Azure Sentinel instance is deployed."', args=[d.arg(name='resourceGroup', type=d.T.string)]),
    withResourceGroup(resourceGroup): { spec+: { resourceGroup: resourceGroup } },
    '#withSubscriptionID':: d.fn(help='"subscriptionID refers to the Azure Subscription ID that the Azure Sentinel instance is associated with."', args=[d.arg(name='subscriptionID', type=d.T.string)]),
    withSubscriptionID(subscriptionID): { spec+: { subscriptionID: subscriptionID } },
    '#withWorkspace':: d.fn(help='"workspace refers to the workspace name in Azure Sentinel."', args=[d.arg(name='workspace', type=d.T.string)]),
    withWorkspace(workspace): { spec+: { workspace: workspace } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
