{
  ...
  '#':: d.pkg(name='azureServiceBusTarget', url='', help='"TriggerMesh event target for Azure Service Bus."'),
  ...
  '#new':: d.fn(help='new returns an instance of AzureServiceBusTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method to interact with the Azure Service Bus REST API."'),
    auth: {
      ...
      sasToken: {
        '#connectionString':: d.obj(help="\"Connection string containing both the resource URI of the Service Bus instance, and the SAS token. Mutually exclusive with 'keyName' and 'keyValue'.\""),
        connectionString: {
    ...
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in objects created in Azure Service Bus. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
