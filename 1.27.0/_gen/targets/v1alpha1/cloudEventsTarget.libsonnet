{
  ...
  '#':: d.pkg(name='cloudEventsTarget', url='', help='"TriggerMesh event target that acts as a gateway for outgoing CloudEvents."'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudEventsTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#credentials':: d.obj(help='"Optional credentials specification for remote CloudEvents endpoint."'),
    credentials: {
      '#basicAuth':: d.obj(help='"HTTP basic authentication parameters."'),
      basicAuth: {
        ...
        password: {
          ...
          valueFromSecret: {
            ...
            withKey(key): { spec+: { credentials+: { basicAuth+: { password+: { valueFromSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the Secret object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { credentials+: { basicAuth+: { password+: { valueFromSecret+: { name: name } } } } } },
          },
        },
        '#withUsername':: d.fn(help='"User name for HTTP Basic authentication."', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { spec+: { credentials+: { basicAuth+: { username: username } } } },
      },
    },
    '#withEndpoint':: d.fn(help='"An HTTP CloudEvents endpoint to stream events to."', args=[d.arg(name='endpoint', type=d.T.string)]),
    withEndpoint(endpoint): { spec+: { endpoint: endpoint } },
    '#withPath':: d.fn(help='"Path at the remote endpoint under which requests are accepted."', args=[d.arg(name='path', type=d.T.string)]),
