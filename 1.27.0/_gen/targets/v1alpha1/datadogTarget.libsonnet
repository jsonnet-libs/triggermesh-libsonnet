{
  ...
  '#':: d.pkg(name='datadogTarget', url='', help='"TriggerMesh event target for Datadog."'),
  ...
  '#new':: d.fn(help='new returns an instance of DatadogTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#apiKey':: d.obj(help='"Datadog API Key with access to receive metrics."'),
    apiKey: {
    ...
    '#withSite':: d.fn(help='"Controls the site of the Datadog intake API"', args=[d.arg(name='site', type=d.T.string)]),
