{
  ...
  '#':: d.pkg(name='elasticsearchTarget', url='', help='"TriggerMesh event target for Elasticsearch."'),
  ...
  '#new':: d.fn(help='new returns an instance of ElasticsearchTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#connection':: d.obj(help='"Attributes for connecting to a private Elasticsearch instance or Elastic cloud."'),
    connection: {
      '#apiKey':: d.obj(help='"API Key to connect to the Elasticsearch instance."'),
      apiKey: {
        '#secretKeyRef':: d.obj(help=''),
        secretKeyRef: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { connection+: { apiKey+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { connection+: { apiKey+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#password':: d.obj(help='"Elasticsearch instance password."'),
      password: {
        '#secretKeyRef':: d.obj(help=''),
        secretKeyRef: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { connection+: { password+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { connection+: { password+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#withAddresses':: d.fn(help='"Hostname/IP Address of the Elasticsearch instance to stream events to."', args=[d.arg(name='addresses', type=d.T.array)]),
      withAddresses(addresses): { spec+: { connection+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } },
      '#withAddressesMixin':: d.fn(help='"Hostname/IP Address of the Elasticsearch instance to stream events to."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addresses', type=d.T.array)]),
      withAddressesMixin(addresses): { spec+: { connection+: { addresses+: if std.isArray(v=addresses) then addresses else [addresses] } } },
      '#withSkipVerify':: d.fn(help='"Skip verification of SSL/TLS certificates."', args=[d.arg(name='skipVerify', type=d.T.boolean)]),
      withSkipVerify(skipVerify): { spec+: { connection+: { skipVerify: skipVerify } } },
      '#withUsername':: d.fn(help='"Elasticsearch instance username."', args=[d.arg(name='username', type=d.T.string)]),
      withUsername(username): { spec+: { connection+: { username: username } } },
    },
    ...
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in documents created in Elasticsearch. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
    withDiscardCloudEventContext(discardCloudEventContext): { spec+: { discardCloudEventContext: discardCloudEventContext } },
    '#withIndexName':: d.fn(help='"Elasticsearch index to stream the events to."', args=[d.arg(name='indexName', type=d.T.string)]),
    withIndexName(indexName): { spec+: { indexName: indexName } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
