{
  ...
  '#':: d.pkg(name='googleCloudFirestoreTarget', url='', help='"TriggerMesh event target for Google Cloud Firestore."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudFirestoreTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#credentialsJson':: d.obj(help='"Deprecated, please use spec.auth.serviceAccountKey object."'),
    credentialsJson: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { credentialsJson+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { credentialsJson+: { secretKeyRef+: { name: name } } } },
      },
    },
    ...
    '#withDefaultCollection':: d.fn(help='"Default firestore collection to stream events into."', args=[d.arg(name='defaultCollection', type=d.T.string)]),
    withDefaultCollection(defaultCollection): { spec+: { defaultCollection: defaultCollection } },
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in documents created in Firestore. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included. component only."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
    withDiscardCloudEventContext(discardCloudEventContext): { spec+: { discardCloudEventContext: discardCloudEventContext } },
    '#withProjectID':: d.fn(help='"Google Cloud Project ID associated with the firestore database."', args=[d.arg(name='projectID', type=d.T.string)]),
