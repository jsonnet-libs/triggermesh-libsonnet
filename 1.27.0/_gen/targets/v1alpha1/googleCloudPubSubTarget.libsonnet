{
  ...
  '#':: d.pkg(name='googleCloudPubSubTarget', url='', help='"TriggerMesh event target for Google Cloud Pub/Sub."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudPubSubTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withTopic':: d.fn(help='"Full resource name of the Pub/Sub topic to stream events to, in the format \\"projects/{project_name}/topics/{topic_name}\\"."', args=[d.arg(name='topic', type=d.T.string)]),
