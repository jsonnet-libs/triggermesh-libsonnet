{
  ...
  '#':: d.pkg(name='googleCloudStorageTarget', url='', help='"TriggerMesh event target for Google Cloud Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudStorageTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withBucketName':: d.fn(help='"GCP Storage bucket to stream events to. Must meet the naming requirements described at https://cloud.google.com/storage/docs/naming-buckets"', args=[d.arg(name='bucketName', type=d.T.string)]),
    withBucketName(bucketName): { spec+: { bucketName: bucketName } },
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in objects created in GCP Storage. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
