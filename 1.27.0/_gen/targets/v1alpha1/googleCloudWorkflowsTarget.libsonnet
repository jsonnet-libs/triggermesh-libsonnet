{
  ...
  '#':: d.pkg(name='googleCloudWorkflowsTarget', url='', help='"TriggerMesh event target for Google Cloud Workflows."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleCloudWorkflowsTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
