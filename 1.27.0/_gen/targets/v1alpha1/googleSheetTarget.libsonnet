{
  ...
  '#':: d.pkg(name='googleSheetTarget', url='', help='"TriggerMesh event target for appending or updating a Googlesheet."'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleSheetTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#googleServiceAccount':: d.obj(help='"Deprecated, please use spec.auth.serviceAccountKey object."'),
    googleServiceAccount: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { googleServiceAccount+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { googleServiceAccount+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#withDefaultPrefix':: d.fn(help='"A prefix to be used when creating a new sheet inside a document."', args=[d.arg(name='defaultPrefix', type=d.T.string)]),
    withDefaultPrefix(defaultPrefix): { spec+: { defaultPrefix: defaultPrefix } },
    '#withId':: d.fn(help='"Googlesheet ID associated with the document being targeted."', args=[d.arg(name='id', type=d.T.string)]),
