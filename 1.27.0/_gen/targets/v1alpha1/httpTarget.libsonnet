{
  ...
  '#':: d.pkg(name='httpTarget', url='', help='"TriggerMesh event target for generic HTTP endpoints."'),
  ...
  '#new':: d.fn(help='new returns an instance of HTTPTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#basicAuthPassword':: d.obj(help='"When using HTTP Basic authentication, the password to connect to the target service."'),
    basicAuthPassword: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { basicAuthPassword+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { basicAuthPassword+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#oauthClientSecret':: d.obj(help='"When using OAuth, the client secret used to authenticate against the target service"'),
    oauthClientSecret: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oauthClientSecret+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oauthClientSecret+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#response':: d.obj(help='"HTTP target response event attributes."'),
    response: {
      '#withEventSource':: d.fn(help='"EventSource is an optional but recommended field for identifying the instance producing the events."', args=[d.arg(name='eventSource', type=d.T.string)]),
      withEventSource(eventSource): { spec+: { response+: { eventSource: eventSource } } },
      '#withEventType':: d.fn(help='"EventType is required to set the Type for the ingested event."', args=[d.arg(name='eventType', type=d.T.string)]),
      withEventType(eventType): { spec+: { response+: { eventType: eventType } } },
    },
    '#withBasicAuthUsername':: d.fn(help='"When using HTTP Basic authentication, the username to connect to the target service."', args=[d.arg(name='basicAuthUsername', type=d.T.string)]),
    withBasicAuthUsername(basicAuthUsername): { spec+: { basicAuthUsername: basicAuthUsername } },
    '#withCaCertificate':: d.fn(help='"The CA certificate used to sign the certificated used by the target server."', args=[d.arg(name='caCertificate', type=d.T.string)]),
    withCaCertificate(caCertificate): { spec+: { caCertificate: caCertificate } },
    '#withEndpoint':: d.fn(help='"An HTTP based REST endpoint to stream events to."', args=[d.arg(name='endpoint', type=d.T.string)]),
    withEndpoint(endpoint): { spec+: { endpoint: endpoint } },
    '#withHeaders':: d.fn(help='"Additional headers required to be set when communicating wiht the target service."', args=[d.arg(name='headers', type=d.T.object)]),
    withHeaders(headers): { spec+: { headers: headers } },
    '#withHeadersMixin':: d.fn(help='"Additional headers required to be set when communicating wiht the target service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.object)]),
    withHeadersMixin(headers): { spec+: { headers+: headers } },
    '#withMethod':: d.fn(help='"The HTTP method to use for the request."', args=[d.arg(name='method', type=d.T.string)]),
    withMethod(method): { spec+: { method: method } },
    '#withOauthClientID':: d.fn(help='"When using OAuth, the client id used to authenticate against the target service."', args=[d.arg(name='oauthClientID', type=d.T.string)]),
    withOauthClientID(oauthClientID): { spec+: { oauthClientID: oauthClientID } },
    '#withOauthScopes':: d.fn(help='"When using OAuth, the scopes required by the target to use the service."', args=[d.arg(name='oauthScopes', type=d.T.array)]),
    withOauthScopes(oauthScopes): { spec+: { oauthScopes: if std.isArray(v=oauthScopes) then oauthScopes else [oauthScopes] } },
    '#withOauthScopesMixin':: d.fn(help='"When using OAuth, the scopes required by the target to use the service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='oauthScopes', type=d.T.array)]),
    withOauthScopesMixin(oauthScopes): { spec+: { oauthScopes+: if std.isArray(v=oauthScopes) then oauthScopes else [oauthScopes] } },
    '#withOauthTokenURL':: d.fn(help='"When using OAuth, the Token URL used to sign the request against."', args=[d.arg(name='oauthTokenURL', type=d.T.string)]),
    withOauthTokenURL(oauthTokenURL): { spec+: { oauthTokenURL: oauthTokenURL } },
    '#withSkipVerify':: d.fn(help='"Skip validation and verification of the SSL/TLS certificate."', args=[d.arg(name='skipVerify', type=d.T.boolean)]),
    withSkipVerify(skipVerify): { spec+: { skipVerify: skipVerify } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
