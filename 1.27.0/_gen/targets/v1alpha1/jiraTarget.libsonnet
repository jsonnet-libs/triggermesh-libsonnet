{
  ...
  '#':: d.pkg(name='jiraTarget', url='', help='"TriggerMesh event target for Jira."'),
  ...
  '#new':: d.fn(help='new returns an instance of JiraTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Credentials to authenticate against the Jira instance."'),
    auth: {
      '#token':: d.obj(help='"Jira API token associated with the Jira user."'),
      token: {
        '#secretKeyRef':: d.obj(help=''),
        secretKeyRef: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { auth+: { token+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { auth+: { token+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#withUser':: d.fn(help='"Jira username for the target to use."', args=[d.arg(name='user', type=d.T.string)]),
    ...
    '#withUrl':: d.fn(help='"Jira instance url."', args=[d.arg(name='url', type=d.T.string)]),
