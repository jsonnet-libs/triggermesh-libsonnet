{
  ...
  '#':: d.pkg(name='logzMetricsTarget', url='', help='"The OpenTelemetry metrics target pushes metrics to a range of backends."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogzMetricsTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'targets.triggermesh.io/v1alpha1',
    kind: 'LogzMetricsTarget',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"The OpenTelemetry target exposes a common interface to a range of metrics backends."'),
  spec: {
    ...
    '#connection':: d.obj(help='"Connection information for LogzMetrics."'),
    connection: {
      '#token':: d.obj(help='"Token for connecting to Logz metrics listener."'),
      token: {
        '#secretKeyRef':: d.obj(help=''),
        secretKeyRef: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { connection+: { token+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { connection+: { token+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#withListenerURL':: d.fn(help='"Listener URL for pushing metrics."', args=[d.arg(name='listenerURL', type=d.T.string)]),
      withListenerURL(listenerURL): { spec+: { connection+: { listenerURL: listenerURL } } },
    },
    '#eventOptions':: d.obj(help='"Event replies options."'),
    eventOptions: {
      '#withPayloadPolicy':: d.fn(help='"Whether this target should generate response events. Possible values are\\n- always, if a response is available it will be sent. - error, only responses categorized as errors will be sent. - never, no responses will be sent."', args=[d.arg(name='payloadPolicy', type=d.T.string)]),
      withPayloadPolicy(payloadPolicy): { spec+: { eventOptions+: { payloadPolicy: payloadPolicy } } },
    },
    '#instruments':: d.obj(help='"Instruments configured for pushing metrics. It is mandatory that all metrics pushed by using this target are pre-registered using this list."'),
    instruments: {
      '#withDescription':: d.fn(help='"Description for the Instrument."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { description: description },
      '#withInstrument':: d.fn(help='"Instrument Kind as defined by OpenTelemetry. Supported values are\\n- Histogram, for absolute values that can be aggregated. - Counter, for delta values that increase monotonically. - UpDownCounter, for delta values that can increase and decrease."', args=[d.arg(name='instrument', type=d.T.string)]),
      withInstrument(instrument): { instrument: instrument },
      '#withName':: d.fn(help='"Name for the Instrument."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withNumber':: d.fn(help='"Number Kind as defined by OpenTelemetry. Defines the measure data type accepted by the Instrument. Supported values are\\n- Int64 - Float64"', args=[d.arg(name='number', type=d.T.string)]),
      withNumber(number): { number: number },
    },
    '#withInstruments':: d.fn(help='"Instruments configured for pushing metrics. It is mandatory that all metrics pushed by using this target are pre-registered using this list."', args=[d.arg(name='instruments', type=d.T.array)]),
    withInstruments(instruments): { spec+: { instruments: if std.isArray(v=instruments) then instruments else [instruments] } },
    '#withInstrumentsMixin':: d.fn(help='"Instruments configured for pushing metrics. It is mandatory that all metrics pushed by using this target are pre-registered using this list."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='instruments', type=d.T.array)]),
    withInstrumentsMixin(instruments): { spec+: { instruments+: if std.isArray(v=instruments) then instruments else [instruments] } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
