{
  ...
  '#':: d.pkg(name='logzTarget', url='', help='"TriggerMesh event target for Logz."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogzTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#shippingToken':: d.obj(help='"API token used to authenticate the event being streamed."'),
    shippingToken: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { shippingToken+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { shippingToken+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#withLogsListenerURL':: d.fn(help='"Logz listener host to stream events to."', args=[d.arg(name='logsListenerURL', type=d.T.string)]),
    withLogsListenerURL(logsListenerURL): { spec+: { logsListenerURL: logsListenerURL } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
