{
  ...
  '#':: d.pkg(name='mongoDBTarget', url='', help='"TriggerMesh event target for MongoDB."'),
  ...
  '#new':: d.fn(help='new returns an instance of MongoDBTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#connectionString':: d.obj(help='"The connection string containing the endpoint for the MongoDB Server and the Username + Password to connect with the instance. EX. mongodb+srv://<user>:<password>@<database_url>/?retryWrites=true&w=majority."'),
    connectionString: {
      ...
      valueFromSecret: {
        ...
        withKey(key): { spec+: { connectionString+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { connectionString+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { connectionString+: { value: value } } },
    },
    '#withCollection':: d.fn(help='"Define the default (over-writeable at runtime) collection to write new events to."', args=[d.arg(name='collection', type=d.T.string)]),
    withCollection(collection): { spec+: { collection: collection } },
    '#withDatabase':: d.fn(help='"Define the default (over-writeable at runtime) database to write new events to."', args=[d.arg(name='database', type=d.T.string)]),
    withDatabase(database): { spec+: { database: database } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
