{
  ...
  '#':: d.pkg(name='oracleTarget', url='', help='"TriggerMesh event target for Oracle Cloud (OCI)."'),
  ...
  '#new':: d.fn(help='new returns an instance of OracleTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#function':: d.obj(help='"Invoke a serverless function on the Oracle Cloud."'),
    'function': {
      '#withFunction':: d.fn(help='"The Oracle Cloud ID (OCID) of the function being invoked."', args=[d.arg(name='Function', type=d.T.string)]),
      withFunction(Function): { spec+: { 'function'+: { 'function': Function } } },
    },
    '#oracleApiPrivateKey':: d.obj(help='"Oracle API Private Key to sign each request to the Oracle Cloud. For details on how to create a private keypair for Oracle Cloud, refer to https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm."'),
    oracleApiPrivateKey: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oracleApiPrivateKey+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oracleApiPrivateKey+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#oracleApiPrivateKeyFingerprint':: d.obj(help='"MD5 fingerprint to identify the keypair associated with the key used to sign each request to the Oracle Cloud. For details on how to create a private keypair for Oracle Cloud, refer to https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm."'),
    oracleApiPrivateKeyFingerprint: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oracleApiPrivateKeyFingerprint+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oracleApiPrivateKeyFingerprint+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#oracleApiPrivateKeyPassphrase':: d.obj(help='"Passphrase to unlock the private key used to sign each request to the Oracle Cloud. For details on how to create a private keypair for Oracle Cloud, refer to https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm."'),
    oracleApiPrivateKeyPassphrase: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { oracleApiPrivateKeyPassphrase+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oracleApiPrivateKeyPassphrase+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#withOracleRegion':: d.fn(help='"The Oracle Cloud region containing the service being executed. A full list of supported regions can be found at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm."', args=[d.arg(name='oracleRegion', type=d.T.string)]),
    withOracleRegion(oracleRegion): { spec+: { oracleRegion: oracleRegion } },
    '#withOracleTenancy':: d.fn(help='"The Oracle Cloud ID (OCID) of the tenant containing the service to be used on the Oracle Cloud."', args=[d.arg(name='oracleTenancy', type=d.T.string)]),
    withOracleTenancy(oracleTenancy): { spec+: { oracleTenancy: oracleTenancy } },
    '#withOracleUser':: d.fn(help='"The Oracle Cloud ID (OCID) of the user who owns the key used to interact with the Oracle Cloud."', args=[d.arg(name='oracleUser', type=d.T.string)]),
