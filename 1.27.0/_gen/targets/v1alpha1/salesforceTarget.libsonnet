{
  ...
  '#':: d.pkg(name='salesforceTarget', url='', help='"TriggerMesh event target for Salesforce."'),
  ...
  '#new':: d.fn(help='new returns an instance of SalesforceTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Attributes required to setup OAuth authentication with Salesforce. To create the credentials, refer to https://help.salesforce.com/articleView?id=sf.remoteaccess_oauth_jwt_flow.htm."'),
    auth: {
      '#certKey':: d.obj(help='"Salesforce requires a certificate to facilitate the authentication flow."'),
      certKey: {
        '#secretKeyRef':: d.obj(help=''),
        secretKeyRef: {
          '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { auth+: { certKey+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { auth+: { certKey+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#withClientID':: d.fn(help='"OAuth Client ID used to identify the target."', args=[d.arg(name='clientID', type=d.T.string)]),
      withClientID(clientID): { spec+: { auth+: { clientID: clientID } } },
      '#withServer':: d.fn(help='"The Salesforce authentication URL associated with the instance being used."', args=[d.arg(name='server', type=d.T.string)]),
      withServer(server): { spec+: { auth+: { server: server } } },
      '#withUser':: d.fn(help='"Username associated with the Salesforce account."', args=[d.arg(name='user', type=d.T.string)]),
    ...
    '#withApiVersion':: d.fn(help="\"Salesforce API version to use for the target's integration with Salesforce.\"", args=[d.arg(name='apiVersion', type=d.T.string)]),
