{
  ...
  '#':: d.pkg(name='sendGridTarget', url='', help='"TriggerMesh event target for Sendgrid."'),
  ...
  '#new':: d.fn(help='new returns an instance of SendGridTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#apiKey':: d.obj(help='"The Sendgrid API key used to authenticate access."'),
    apiKey: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { apiKey+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { apiKey+: { secretKeyRef+: { name: name } } } },
      },
    },
    ...
    '#withDefaultFromEmail':: d.fn(help='"Default sender email address for sending mail via Sendgrid."', args=[d.arg(name='defaultFromEmail', type=d.T.string)]),
    withDefaultFromEmail(defaultFromEmail): { spec+: { defaultFromEmail: defaultFromEmail } },
    '#withDefaultFromName':: d.fn(help='"Default name to use for the from field when sending email via Sendgrid."', args=[d.arg(name='defaultFromName', type=d.T.string)]),
    withDefaultFromName(defaultFromName): { spec+: { defaultFromName: defaultFromName } },
    '#withDefaultMessage':: d.fn(help='"Default message to use for all email sent via this target."', args=[d.arg(name='defaultMessage', type=d.T.string)]),
    withDefaultMessage(defaultMessage): { spec+: { defaultMessage: defaultMessage } },
    '#withDefaultSubject':: d.fn(help='"Default subject to use for email sent via this target"', args=[d.arg(name='defaultSubject', type=d.T.string)]),
    withDefaultSubject(defaultSubject): { spec+: { defaultSubject: defaultSubject } },
    '#withDefaultToEmail':: d.fn(help='"Default email address to send mail to via Sendgrid."', args=[d.arg(name='defaultToEmail', type=d.T.string)]),
    withDefaultToEmail(defaultToEmail): { spec+: { defaultToEmail: defaultToEmail } },
    '#withDefaultToName':: d.fn(help='"Default name to use for the to field when sending email via Sendgrid."', args=[d.arg(name='defaultToName', type=d.T.string)]),
    withDefaultToName(defaultToName): { spec+: { defaultToName: defaultToName } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
