{
  ...
  '#':: d.pkg(name='slackTarget', url='', help='"TriggerMesh event target for Slack Web API."'),
  ...
  '#new':: d.fn(help='new returns an instance of SlackTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#token':: d.obj(help='"Slack API token used to interface with Slack. Consult the Slack API documenation for details on how to setup an app for the target https://api.slack.com/web#authentication."'),
    token: {
