{
  ...
  '#':: d.pkg(name='solaceTarget', url='', help='"TriggerMesh event target for Solace."'),
  ...
  '#new':: d.fn(help='new returns an instance of SolaceTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#auth':: d.obj(help='"Authentication method used to interact with Solace."'),
    auth: {
      '#password':: d.obj(help='"Solace account password."'),
      password: {
      ...
      '#tls':: d.obj(help='"TLS Authentication method to interact with Solace."'),
      tls: {
      ...
      '#withUsername':: d.fn(help='"Solace account username."', args=[d.arg(name='username', type=d.T.string)]),
      withUsername(username): { spec+: { auth+: { username: username } } },
    },
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in messages sent to Solace. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
    withDiscardCloudEventContext(discardCloudEventContext): { spec+: { discardCloudEventContext: discardCloudEventContext } },
    '#withQueueName':: d.fn(help='"Queue name to stream the target events to."', args=[d.arg(name='queueName', type=d.T.string)]),
    withQueueName(queueName): { spec+: { queueName: queueName } },
    '#withUrl':: d.fn(help='"Solace server used to bootstrap the connection."', args=[d.arg(name='url', type=d.T.string)]),
