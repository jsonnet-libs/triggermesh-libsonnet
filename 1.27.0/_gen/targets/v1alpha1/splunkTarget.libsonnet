{
  ...
  '#':: d.pkg(name='splunkTarget', url='', help='"TriggerMesh event target for Splunk."'),
  ...
  '#new':: d.fn(help='new returns an instance of SplunkTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#token':: d.obj(help='"Token for authenticating requests against the HEC. See https://docs.splunk.com/Documentation/Splunk/latest/Data/UsetheHTTPEventCollector#About_Event_Collector_tokens."'),
    token: {
      '#valueFromSecret':: d.obj(help=''),
      valueFromSecret: {
    ...
    '#withDiscardCloudEventContext':: d.fn(help='"Whether to omit CloudEvent context attributes in messages sent to Splunk. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."', args=[d.arg(name='discardCloudEventContext', type=d.T.boolean)]),
    withDiscardCloudEventContext(discardCloudEventContext): { spec+: { discardCloudEventContext: discardCloudEventContext } },
    '#withEndpoint':: d.fn(help='"URL of the HTTP Event Collector (HEC). Only the scheme, hostname, and port (optionally) are evaluated. When the URL path is not present, the one documented at Splunk is automatically used. See https://docs.splunk.com/Documentation/Splunk/latest/Data/UsetheHTTPEventCollector#Enable_HTTP_Event_Collector."', args=[d.arg(name='endpoint', type=d.T.string)]),
    withEndpoint(endpoint): { spec+: { endpoint: endpoint } },
    '#withIndex':: d.fn(help="\"Name of the index to send events to. When undefined, events are sent to the default index defined in the HEC token's configuration.\"", args=[d.arg(name='index', type=d.T.string)]),
    withIndex(index): { spec+: { index: index } },
    '#withSkipTLSVerify':: d.fn(help='"Control whether the target should verify the SSL/TLS certificate used by the event collector."', args=[d.arg(name='skipTLSVerify', type=d.T.boolean)]),
