{
  ...
  '#':: d.pkg(name='twilioTarget', url='', help='"TriggerMesh event target for Twilio."'),
  ...
  '#new':: d.fn(help='new returns an instance of TwilioTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#sid':: d.obj(help='"Twilio account service ID (SID)"'),
    sid: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { sid+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { sid+: { secretKeyRef+: { name: name } } } },
      },
    },
    '#token':: d.obj(help='"Twilio API Token."'),
    token: {
      '#secretKeyRef':: d.obj(help=''),
      secretKeyRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#withDefaultPhoneFrom':: d.fn(help='"Default phone number to send the message from."', args=[d.arg(name='defaultPhoneFrom', type=d.T.string)]),
    withDefaultPhoneFrom(defaultPhoneFrom): { spec+: { defaultPhoneFrom: defaultPhoneFrom } },
    '#withDefaultPhoneTo':: d.fn(help='"Default phone number to send the message to."', args=[d.arg(name='defaultPhoneTo', type=d.T.string)]),
    withDefaultPhoneTo(defaultPhoneTo): { spec+: { defaultPhoneTo: defaultPhoneTo } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
