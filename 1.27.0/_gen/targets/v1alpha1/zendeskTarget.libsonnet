{
  ...
  '#':: d.pkg(name='zendeskTarget', url='', help='"TriggerMesh event target for Zendesk."'),
  ...
  '#new':: d.fn(help='new returns an instance of ZendeskTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#token':: d.obj(help='"Zendesk API token for interacting with Zendesk."'),
    token: {
    ...
    '#withEmail':: d.fn(help='"Default registered email address for interacting with Zendesk."', args=[d.arg(name='email', type=d.T.string)]),
    withEmail(email): { spec+: { email: email } },
    '#withSubdomain':: d.fn(help="\"User's subdomain on zendesk being targeted.\"", args=[d.arg(name='subdomain', type=d.T.string)]),
    withSubdomain(subdomain): { spec+: { subdomain: subdomain } },
    '#withSubject':: d.fn(help='"Default subject line to use for tickets created using this target."', args=[d.arg(name='subject', type=d.T.string)]),
    withSubject(subject): { spec+: { subject: subject } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
