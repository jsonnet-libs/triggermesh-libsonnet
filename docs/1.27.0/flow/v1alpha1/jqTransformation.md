---
permalink: /1.27.0/flow/v1alpha1/jqTransformation/
---

# flow.v1alpha1.jqTransformation

"TriggerMesh CloudEvents JSON Query Transformation engine."
...
new returns an instance of JQTransformation
...
"Desired state of the transformer."
...
"The JSON Query to perform on the incoming event"
