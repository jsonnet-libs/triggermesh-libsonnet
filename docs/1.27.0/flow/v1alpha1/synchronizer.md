---
permalink: /1.27.0/flow/v1alpha1/synchronizer/
---

# flow.v1alpha1.synchronizer
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.correlationKey`](#obj-speccorrelationkey)
    * [`fn withAttribute(attribute)`](#fn-speccorrelationkeywithattribute)
    * [`fn withLength(length)`](#fn-speccorrelationkeywithlength)
  * [`obj spec.response`](#obj-specresponse)
    * [`fn withTimeout(timeout)`](#fn-specresponsewithtimeout)
...
new returns an instance of Synchronizer
...
"Desired state of the event synchronizer."
...
## obj spec.correlationKey

"Events correlation parameters."

### fn spec.correlationKey.withAttribute

```ts
withAttribute(attribute)
```

"The name of the correlation key that will be injected into the CloudEvents context. Events without this attribute are forwarded to the Sink as the client requests while client connections are held open. Events, which context already has the correlation key, are sent back to the open client connections."

### fn spec.correlationKey.withLength

```ts
withLength(length)
```

"The length of the correlation key to generate. The default value is 24."

## obj spec.response

"Responses handling configuration."

### fn spec.response.withTimeout

```ts
withTimeout(timeout)
```

"The time during which the synchronizer will block the client and wait for the response. Expressed as a duration string, which format is documented at https://pkg.go.dev/time#ParseDuration."

## obj spec.sink

"The destination where the synchronizer will forward incoming requests from the clients."
