---
permalink: /1.27.0/flow/v1alpha1/transformation/
---

# flow.v1alpha1.transformation

"TriggerMesh CloudEvents transformation engine. Allows to declaratively perform data transformations on CloudEvents."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.context`](#obj-speccontext)
    * [`fn withOperation(operation)`](#fn-speccontextwithoperation)
    * [`fn withPaths(paths)`](#fn-speccontextwithpaths)
    * [`fn withPathsMixin(paths)`](#fn-speccontextwithpathsmixin)
    * [`obj spec.context.paths`](#obj-speccontextpaths)
      * [`fn withKey(key)`](#fn-speccontextpathswithkey)
      * [`fn withSeparator(separator)`](#fn-speccontextpathswithseparator)
      * [`fn withValue(value)`](#fn-speccontextpathswithvalue)
  * [`obj spec.data`](#obj-specdata)
    * [`fn withOperation(operation)`](#fn-specdatawithoperation)
    * [`fn withPaths(paths)`](#fn-specdatawithpaths)
    * [`fn withPathsMixin(paths)`](#fn-specdatawithpathsmixin)
    * [`obj spec.data.paths`](#obj-specdatapaths)
      * [`fn withKey(key)`](#fn-specdatapathswithkey)
      * [`fn withSeparator(separator)`](#fn-specdatapathswithseparator)
      * [`fn withValue(value)`](#fn-specdatapathswithvalue)
...
new returns an instance of Transformation
...
### fn spec.context.withPaths

```ts
withPaths(paths)
```

"Key-value event pairs to apply the transformations on."

### fn spec.context.withPathsMixin
...
## obj spec.context.paths

"Key-value event pairs to apply the transformations on."

### fn spec.context.paths.withKey

```ts
withKey(key)
```

"JSON path or variable name. Depends on the operation type."

### fn spec.context.paths.withSeparator

```ts
withSeparator(separator)
```

"JSON path separator symbol. \".\" is used by default."

### fn spec.context.paths.withValue
...
### fn spec.data.paths.withSeparator
