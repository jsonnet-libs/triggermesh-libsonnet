---
permalink: /1.27.0/flow/v1alpha1/xsltTransformation/
---

# flow.v1alpha1.xsltTransformation

"TriggerMesh CloudEvents XSLT transformation."
...
* [`obj spec`](#obj-spec)
  * [`fn withAllowPerEventXSLT(allowPerEventXSLT)`](#fn-specwithallowpereventxslt)
  ...
  * [`obj spec.xslt`](#obj-specxslt)
    * [`fn withValue(value)`](#fn-specxsltwithvalue)
    * [`obj spec.xslt.valueFromConfigMap`](#obj-specxsltvaluefromconfigmap)
      * [`fn withKey(key)`](#fn-specxsltvaluefromconfigmapwithkey)
      * [`fn withName(name)`](#fn-specxsltvaluefromconfigmapwithname)
    * [`obj spec.xslt.valueFromSecret`](#obj-specxsltvaluefromsecret)
      * [`fn withKey(key)`](#fn-specxsltvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specxsltvaluefromsecretwithname)
...
new returns an instance of XSLTTransformation
...
### fn spec.withAllowPerEventXSLT

```ts
withAllowPerEventXSLT(allowPerEventXSLT)
```
...
## obj spec.xslt.valueFromConfigMap

"A reference to a Kubernetes ConfigMap object containing the value."

### fn spec.xslt.valueFromConfigMap.withKey
...
### fn spec.xslt.valueFromConfigMap.withName
...
## obj spec.xslt.valueFromSecret

"A reference to a Kubernetes Secret object containing the value."

### fn spec.xslt.valueFromSecret.withKey
...
### fn spec.xslt.valueFromSecret.withName
