---
permalink: /1.27.0/routing/v1alpha1/splitter/
---

# routing.v1alpha1.splitter

"TriggerMesh content-based events splitter."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.ceContext`](#obj-speccecontext)
    * [`fn withExtensions(extensions)`](#fn-speccecontextwithextensions)
    * [`fn withExtensionsMixin(extensions)`](#fn-speccecontextwithextensionsmixin)
    * [`fn withSource(source)`](#fn-speccecontextwithsource)
    * [`fn withType(type)`](#fn-speccecontextwithtype)
...
new returns an instance of Splitter
...
"JSONPath expression representing the key containing the data array to split. Defaults to the root."
...
### fn spec.ceContext.withExtensions

```ts
withExtensions(extensions)
```

"Additional context extensions to set on produced CloudEvents."

### fn spec.ceContext.withExtensionsMixin
...
### fn spec.ceContext.withSource

```ts
withSource(source)
```

"CloudEvent \"source\" context attribute. Accepts a JSONPath expressions in brackets (e.g. \"user/{.name}\")."

### fn spec.ceContext.withType
