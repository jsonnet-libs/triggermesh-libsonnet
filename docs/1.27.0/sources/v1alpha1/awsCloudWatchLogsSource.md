---
permalink: /1.27.0/sources/v1alpha1/awsCloudWatchLogsSource/
---

# sources.v1alpha1.awsCloudWatchLogsSource

"TriggerMesh event source for Amazon CloudWatch Logs."
...
new returns an instance of AWSCloudWatchLogsSource
...
"ARN of the Log Group to source data from. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoncloudwatchlogs.html#amazoncloudwatchlogs-resources-for-iam-policies"
