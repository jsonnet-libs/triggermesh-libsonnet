---
permalink: /1.27.0/sources/v1alpha1/awsCloudWatchSource/
---

# sources.v1alpha1.awsCloudWatchSource

"TriggerMesh event source for Amazon CloudWatch."
...
* [`obj spec`](#obj-spec)
  * [`fn withMetricQueries(metricQueries)`](#fn-specwithmetricqueries)
  * [`fn withMetricQueriesMixin(metricQueries)`](#fn-specwithmetricqueriesmixin)
  ...
  * [`obj spec.metricQueries`](#obj-specmetricqueries)
    * [`fn withExpression(expression)`](#fn-specmetricquerieswithexpression)
    * [`fn withName(name)`](#fn-specmetricquerieswithname)
    * [`obj spec.metricQueries.metric`](#obj-specmetricqueriesmetric)
      * [`fn withPeriod(period)`](#fn-specmetricqueriesmetricwithperiod)
      * [`fn withStat(stat)`](#fn-specmetricqueriesmetricwithstat)
      * [`fn withUnit(unit)`](#fn-specmetricqueriesmetricwithunit)
      * [`obj spec.metricQueries.metric.metric`](#obj-specmetricqueriesmetricmetric)
        * [`fn withDimensions(dimensions)`](#fn-specmetricqueriesmetricmetricwithdimensions)
        * [`fn withDimensionsMixin(dimensions)`](#fn-specmetricqueriesmetricmetricwithdimensionsmixin)
        * [`fn withMetricName(metricName)`](#fn-specmetricqueriesmetricmetricwithmetricname)
        * [`fn withNamespace(namespace)`](#fn-specmetricqueriesmetricmetricwithnamespace)
        * [`obj spec.metricQueries.metric.metric.dimensions`](#obj-specmetricqueriesmetricmetricdimensions)
          * [`fn withName(name)`](#fn-specmetricqueriesmetricmetricdimensionswithname)
          * [`fn withValue(value)`](#fn-specmetricqueriesmetricmetricdimensionswithvalue)
...
new returns an instance of AWSCloudWatchSource
...
### fn spec.withMetricQueries

```ts
withMetricQueries(metricQueries)
```

"List of queries that determine what metrics will be sourced from Amazon CloudWatch. Each item represents an individual MetricDataQuery. For more information, please refer to the CloudWatch API reference at https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_MetricDataQuery.html"

### fn spec.withMetricQueriesMixin

```ts
withMetricQueriesMixin(metricQueries)
```
...
"Code of the AWS region to source metrics from. Available region codes are documented in the AWS General Reference at https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints."
...
## obj spec.metricQueries

"List of queries that determine what metrics will be sourced from Amazon CloudWatch. Each item represents an individual MetricDataQuery. For more information, please refer to the CloudWatch API reference at https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_MetricDataQuery.html"

### fn spec.metricQueries.withExpression

```ts
withExpression(expression)
```

"Math expression to be performed on the metric data. Mutually exclusive with 'metric'."

### fn spec.metricQueries.withName
...
## obj spec.metricQueries.metric

"Representation of a metric with statistics, period, and units, but no math expression. Mutually exclusive with 'expression'."

### fn spec.metricQueries.metric.withPeriod
...
### fn spec.metricQueries.metric.withStat
...
### fn spec.metricQueries.metric.withUnit

```ts
withUnit(unit)
```

"If specified, return only data with that unit."

## obj spec.metricQueries.metric.metric

"The metric to return."

### fn spec.metricQueries.metric.metric.withDimensions
...
### fn spec.metricQueries.metric.metric.withDimensionsMixin
...
### fn spec.metricQueries.metric.metric.withMetricName
...
### fn spec.metricQueries.metric.metric.withNamespace
...
## obj spec.metricQueries.metric.metric.dimensions

"Dimensions of the metric."

### fn spec.metricQueries.metric.metric.dimensions.withName
...
### fn spec.metricQueries.metric.metric.dimensions.withValue
