---
permalink: /1.27.0/sources/v1alpha1/awsCodeCommitSource/
---

# sources.v1alpha1.awsCodeCommitSource

"TriggerMesh event source for Amazon CodeCommit."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withBranch(branch)`](#fn-specwithbranch)
...
new returns an instance of AWSCodeCommitSource
...
"ARN of the CodeCommit repository to receive events from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscodecommit.html#awscodecommit-resources-for-iam-policies."
