---
permalink: /1.27.0/sources/v1alpha1/awsCognitoIdentitySource/
---

# sources.v1alpha1.awsCognitoIdentitySource

"TriggerMesh event source for Amazon Cognito Identity Pool."
...
new returns an instance of AWSCognitoIdentitySource
...
"ARN of the Amazon Cognito Identity Pool to receive notifications from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazoncognitoidentity.html#amazoncognitoidentity-resources-for-iam-policies."
...
"The destination of events sourced from the Amazon Cognito Identity Pool."
