---
permalink: /1.27.0/sources/v1alpha1/awsCognitoUserPoolSource/
---

# sources.v1alpha1.awsCognitoUserPoolSource

"TriggerMesh event source for Amazon Cognito User Pool."
...
new returns an instance of AWSCognitoUserPoolSource
...
"ARN of the Amazon Cognito User Pool to receive notifications from. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoncognitouserpools.html#amazoncognitouserpools-resources-for-iam-policies"
