---
permalink: /1.27.0/sources/v1alpha1/awsDynamoDBSource/
---

# sources.v1alpha1.awsDynamoDBSource

"TriggerMesh event source for Amazon DynamoDB."
...
new returns an instance of AWSDynamoDBSource
...
"ARN of the DynamoDB table to receive modification events from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazondynamodb.html#amazondynamodb-resources-for-iam-policies."
...
"The destination of events sourced from Amazon DynamoDB."
