---
permalink: /1.27.0/sources/v1alpha1/awssnsSource/
---

# sources.v1alpha1.awssnsSource

"TriggerMesh event source for Amazon SNS."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.subscriptionAttributes`](#obj-specsubscriptionattributes)
    * [`fn withDeliveryPolicy(deliveryPolicy)`](#fn-specsubscriptionattributeswithdeliverypolicy)
    * [`fn withFilterPolicy(filterPolicy)`](#fn-specsubscriptionattributeswithfilterpolicy)
    * [`fn withRawMessageDelivery(rawMessageDelivery)`](#fn-specsubscriptionattributeswithrawmessagedelivery)
    * [`fn withRedrivePolicy(redrivePolicy)`](#fn-specsubscriptionattributeswithredrivepolicy)
...
new returns an instance of AWSSNSSource
...
"ARN of the Amazon SNS topic to consume messages from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonsns.html#amazonsns-resources-for-iam-policies"
...
## obj spec.subscriptionAttributes

"Attributes to set on the Amazon SNS Subscription that is used for receiving messages from the SNS topic."

### fn spec.subscriptionAttributes.withDeliveryPolicy

```ts
withDeliveryPolicy(deliveryPolicy)
```

"Policy that defines how Amazon SNS retries failed deliveries to this event source."

### fn spec.subscriptionAttributes.withFilterPolicy

```ts
withFilterPolicy(filterPolicy)
```

"Rules for filtering the messages sent to this event source."

### fn spec.subscriptionAttributes.withRawMessageDelivery

```ts
withRawMessageDelivery(rawMessageDelivery)
```

"Whether to enable raw message delivery to this event source."

### fn spec.subscriptionAttributes.withRedrivePolicy

```ts
withRedrivePolicy(redrivePolicy)
```

"Send undeliverable messages to the specified Amazon SQS dead-letter queue."