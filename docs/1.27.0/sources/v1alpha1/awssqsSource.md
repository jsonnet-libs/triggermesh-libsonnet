---
permalink: /1.27.0/sources/v1alpha1/awssqsSource/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMessageProcessor(messageProcessor)`](#fn-specwithmessageprocessor)
  ...
  * [`obj spec.endpoint`](#obj-specendpoint)
    * [`fn withUrl(url)`](#fn-specendpointwithurl)
  * [`obj spec.receiveOptions`](#obj-specreceiveoptions)
    * [`fn withVisibilityTimeout(visibilityTimeout)`](#fn-specreceiveoptionswithvisibilitytimeout)
...
new returns an instance of AWSSQSSource
...
"ARN of the Amazon SQS queue to consume messages from. The expected format is documented at https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonsqs.html#amazonsqs-resources-for-iam-policies."

### fn spec.withMessageProcessor

```ts
withMessageProcessor(messageProcessor)
```

"Name of the message processor to use for converting SQS messages to CloudEvents. Supported values are \"default\", \"s3\", and \"eventbridge\"."
...
## obj spec.receiveOptions

"Options that control the behavior of message receivers."

### fn spec.receiveOptions.withVisibilityTimeout
