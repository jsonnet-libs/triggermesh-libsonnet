---
permalink: /1.27.0/sources/v1alpha1/azureActivityLogsSource/
---

# sources.v1alpha1.azureActivityLogsSource

"TriggerMesh event source for Azure Activity Logs."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.destination`](#obj-specdestination)
    * [`obj spec.destination.eventHubs`](#obj-specdestinationeventhubs)
      * [`fn withConsumerGroup(consumerGroup)`](#fn-specdestinationeventhubswithconsumergroup)
      * [`fn withHubName(hubName)`](#fn-specdestinationeventhubswithhubname)
      * [`fn withNamespaceID(namespaceID)`](#fn-specdestinationeventhubswithnamespaceid)
      * [`fn withSasPolicy(sasPolicy)`](#fn-specdestinationeventhubswithsaspolicy)
...
new returns an instance of AzureActivityLogsSource
...
"Categories of Activity Logs to collect. All available categories are selected when this attribute is empty. For a list of available Activity Logs category, please refer to https://docs.microsoft.com/en-us/azure/azure-monitor/platform/activity-log-schema#categories."
...
"Authentication method to interact with the Azure Monitor REST API. This event source only supports the Service Principal authentication. If it not present, it will try to use Azure AKS Managed Identity"
...
## obj spec.destination.eventHubs

"Properties of an Event Hubs namespace to use as intermediate destination of activity logs."

### fn spec.destination.eventHubs.withConsumerGroup
...
### fn spec.destination.eventHubs.withHubName
...
### fn spec.destination.eventHubs.withNamespaceID
...
### fn spec.destination.eventHubs.withSasPolicy

```ts
withSasPolicy(sasPolicy)
```

"Name of a SAS policy with Manage permissions inside the Event Hubs namespace referenced by the 'namespaceID' field. Defaults to 'RootManageSharedAccessKey'."

## obj spec.sink

"The destination of events sourced from Azure Activity Logs."
