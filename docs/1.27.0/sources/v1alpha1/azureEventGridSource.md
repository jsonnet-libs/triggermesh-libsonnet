---
permalink: /1.27.0/sources/v1alpha1/azureEventGridSource/
---

# sources.v1alpha1.azureEventGridSource

"TriggerMesh event source for Azure Event Grid."
...
new returns an instance of AzureEventGridSource
...
"Authentication method to interact with the Azure Event Grid and Azure Event Hubs REST APIs. This event source only supports the Service Principal authentication. If it not present, it will try to use Azure AKS Managed Identity"
...
"The destination of events sourced from Azure Event Grid."
