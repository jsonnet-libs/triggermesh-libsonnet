---
permalink: /1.27.0/sources/v1alpha1/azureQueueStorageSource/
---

# sources.v1alpha1.azureQueueStorageSource

"TriggerMesh event source for Azure Queue Storage."
...
* [`obj spec`](#obj-spec)
  * [`fn withAccountName(accountName)`](#fn-specwithaccountname)
  * [`fn withQueueName(queueName)`](#fn-specwithqueuename)
  * [`fn withVisibilityTimeout(visibilityTimeout)`](#fn-specwithvisibilitytimeout)
  * [`obj spec.accountKey`](#obj-specaccountkey)
    * [`fn withValue(value)`](#fn-specaccountkeywithvalue)
    * [`obj spec.accountKey.valueFromSecret`](#obj-specaccountkeyvaluefromsecret)
      * [`fn withKey(key)`](#fn-specaccountkeyvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specaccountkeyvaluefromsecretwithname)
...
new returns an instance of AzureQueueStorageSource
...
"A storage account access key for authenticating against the Azure Storage REST API."

### fn spec.accountKey.withValue

```ts
withValue(value)
```

"Literal value of the account key."

## obj spec.accountKey.valueFromSecret

"A reference to a Kubernetes Secret object containing the account key."

### fn spec.accountKey.valueFromSecret.withKey
...
### fn spec.accountKey.valueFromSecret.withName
