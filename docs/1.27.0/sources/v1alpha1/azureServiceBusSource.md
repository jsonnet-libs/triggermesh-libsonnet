---
permalink: /1.27.0/sources/v1alpha1/azureServiceBusSource/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withMaxConcurrent(maxConcurrent)`](#fn-specwithmaxconcurrent)
...
### fn spec.withMaxConcurrent

```ts
withMaxConcurrent(maxConcurrent)
```

"maximum number of goroutines that will be used to process messages. default 10."
