---
permalink: /1.27.0/sources/v1alpha1/cloudEventsSource/
---

# sources.v1alpha1.cloudEventsSource

"TriggerMesh event source for receiving arbitrary CloudEvents over HTTP."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.ceOverrides`](#obj-specceoverrides)
    * [`obj spec.ceOverrides.extensions`](#obj-specceoverridesextensions)
      * [`fn withSource(source)`](#fn-specceoverridesextensionswithsource)
      * [`fn withSubject(subject)`](#fn-specceoverridesextensionswithsubject)
      * [`fn withType(type)`](#fn-specceoverridesextensionswithtype)
  * [`obj spec.credentials`](#obj-speccredentials)
    * [`fn withBasicAuths(basicAuths)`](#fn-speccredentialswithbasicauths)
    * [`fn withBasicAuthsMixin(basicAuths)`](#fn-speccredentialswithbasicauthsmixin)
    * [`obj spec.credentials.basicAuths`](#obj-speccredentialsbasicauths)
      * [`fn withUsername(username)`](#fn-speccredentialsbasicauthswithusername)
      * [`obj spec.credentials.basicAuths.password`](#obj-speccredentialsbasicauthspassword)
        * [`obj spec.credentials.basicAuths.password.valueFromSecret`](#obj-speccredentialsbasicauthspasswordvaluefromsecret)
          * [`fn withKey(key)`](#fn-speccredentialsbasicauthspasswordvaluefromsecretwithkey)
          * [`fn withName(name)`](#fn-speccredentialsbasicauthspasswordvaluefromsecretwithname)
  * [`obj spec.rateLimiter`](#obj-specratelimiter)
    * [`fn withRequestsPerSecond(requestsPerSecond)`](#fn-specratelimiterwithrequestspersecond)
...
new returns an instance of CloudEventsSource
...
"Specification for the CloudEvents source."
...
"Path where incoming CloudEvents will be accepted."
...
"Defines overrides/additions to incoming CloudEvents attributes."
...
"Optional credentials specification for incoming requests."

### fn spec.credentials.withBasicAuths

```ts
withBasicAuths(basicAuths)
```

"Array of HTTP basic authentication parameters, all present usernames and passwords are considered valid."

### fn spec.credentials.withBasicAuthsMixin

```ts
withBasicAuthsMixin(basicAuths)
```
...
## obj spec.credentials.basicAuths

"Array of HTTP basic authentication parameters, all present usernames and passwords are considered valid."

### fn spec.credentials.basicAuths.withUsername
...
## obj spec.credentials.basicAuths.password

"Password for HTTP Basic authentication."

## obj spec.credentials.basicAuths.password.valueFromSecret

"A reference to a Kubernetes Secret object containing the password."

### fn spec.credentials.basicAuths.password.valueFromSecret.withKey
...
### fn spec.credentials.basicAuths.password.valueFromSecret.withName
...
## obj spec.rateLimiter

"Rate limiter provides a mechanism to reject incoming requests when a threshold is trespassed, informing the caller to retry later."

### fn spec.rateLimiter.withRequestsPerSecond

```ts
withRequestsPerSecond(requestsPerSecond)
```

"Number of requests accepted per time duration."

## obj spec.sink

"The destination of events generated from requests to the source."
