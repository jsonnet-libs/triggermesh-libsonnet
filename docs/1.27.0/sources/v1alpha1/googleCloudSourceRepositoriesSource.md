---
permalink: /1.27.0/sources/v1alpha1/googleCloudSourceRepositoriesSource/
---

# sources.v1alpha1.googleCloudSourceRepositoriesSource

"TriggerMesh event source for Google Cloud Source Repositories."
...
* [`obj spec`](#obj-spec)
  * [`fn withPublishServiceAccount(publishServiceAccount)`](#fn-specwithpublishserviceaccount)
...
new returns an instance of GoogleCloudSourceRepositoriesSource
...
### fn spec.withPublishServiceAccount

```ts
withPublishServiceAccount(publishServiceAccount)
```
...
"Full resource name of the Repository."
...
"Attributes related to the configuration of Pub/Sub resources associated with the Cloud Repositories."
