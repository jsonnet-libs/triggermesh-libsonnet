---
permalink: /1.27.0/sources/v1alpha1/ociMetricsSource/
---

# sources.v1alpha1.ociMetricsSource

"TriggerMesh event source for Oracle Cloud Infrastructure (OCI) Metrics."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMetricsPollingFrequency(metricsPollingFrequency)`](#fn-specwithmetricspollingfrequency)
  * [`fn withOracleRegion(oracleRegion)`](#fn-specwithoracleregion)
  * [`fn withOracleTenancy(oracleTenancy)`](#fn-specwithoracletenancy)
  * [`fn withOracleUser(oracleUser)`](#fn-specwithoracleuser)
  ...
  * [`obj spec.metrics`](#obj-specmetrics)
    * [`fn withMetricsNamespace(metricsNamespace)`](#fn-specmetricswithmetricsnamespace)
    * [`fn withMetricsQuery(metricsQuery)`](#fn-specmetricswithmetricsquery)
    * [`fn withName(name)`](#fn-specmetricswithname)
    * [`fn withOracleCompartment(oracleCompartment)`](#fn-specmetricswithoraclecompartment)
  * [`obj spec.oracleApiPrivateKey`](#obj-specoracleapiprivatekey)
    * [`fn withValue(value)`](#fn-specoracleapiprivatekeywithvalue)
    * [`obj spec.oracleApiPrivateKey.valueFromSecret`](#obj-specoracleapiprivatekeyvaluefromsecret)
      * [`fn withKey(key)`](#fn-specoracleapiprivatekeyvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specoracleapiprivatekeyvaluefromsecretwithname)
  * [`obj spec.oracleApiPrivateKeyFingerprint`](#obj-specoracleapiprivatekeyfingerprint)
    * [`fn withValue(value)`](#fn-specoracleapiprivatekeyfingerprintwithvalue)
    * [`obj spec.oracleApiPrivateKeyFingerprint.valueFromSecret`](#obj-specoracleapiprivatekeyfingerprintvaluefromsecret)
      * [`fn withKey(key)`](#fn-specoracleapiprivatekeyfingerprintvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specoracleapiprivatekeyfingerprintvaluefromsecretwithname)
  * [`obj spec.oracleApiPrivateKeyPassphrase`](#obj-specoracleapiprivatekeypassphrase)
    * [`fn withValue(value)`](#fn-specoracleapiprivatekeypassphrasewithvalue)
    * [`obj spec.oracleApiPrivateKeyPassphrase.valueFromSecret`](#obj-specoracleapiprivatekeypassphrasevaluefromsecret)
      * [`fn withKey(key)`](#fn-specoracleapiprivatekeypassphrasevaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specoracleapiprivatekeypassphrasevaluefromsecretwithname)
...
new returns an instance of OCIMetricsSource
...
### fn spec.withMetricsPollingFrequency

```ts
withMetricsPollingFrequency(metricsPollingFrequency)
```

"Polling frequency of the OCI API for metrics details (supported values 1m-60m, 1h-24h, 1d)."

### fn spec.withOracleRegion

```ts
withOracleRegion(oracleRegion)
```

"OCI target region."

### fn spec.withOracleTenancy

```ts
withOracleTenancy(oracleTenancy)
```

"OCID of the target tenancy."

### fn spec.withOracleUser

```ts
withOracleUser(oracleUser)
```

"OCID of the target user associated with the 'oracleApiPrivateKey'."
...
### fn spec.metrics.withMetricsNamespace

```ts
withMetricsNamespace(metricsNamespace)
```

"Type of metrics to pull from such as oci_computeagent, oci_apigateway, oci_vnc, or oci_compute_infrastructure_health."

### fn spec.metrics.withMetricsQuery

```ts
withMetricsQuery(metricsQuery)
```

"Metrics query to send based off of OCI Monitoring Query Language."
...
"Used as the event source for the metric."

### fn spec.metrics.withOracleCompartment

```ts
withOracleCompartment(oracleCompartment)
```

"OCID of the target compartment (if not specified, default to the value of 'oracleTenancy')."

## obj spec.oracleApiPrivateKey

"PEM encoded API private key that has access to the OCI metrics API."

### fn spec.oracleApiPrivateKey.withValue

```ts
withValue(value)
```

"Literal value of the private key."

## obj spec.oracleApiPrivateKey.valueFromSecret

"A reference to a Kubernetes Secret containing the private key."

### fn spec.oracleApiPrivateKey.valueFromSecret.withKey
...
### fn spec.oracleApiPrivateKey.valueFromSecret.withName
...
## obj spec.oracleApiPrivateKeyFingerprint

"MD5 fingerprint of 'oracleApiPrivateKey'."

### fn spec.oracleApiPrivateKeyFingerprint.withValue

```ts
withValue(value)
```

"Literal value of the fingerprint."

## obj spec.oracleApiPrivateKeyFingerprint.valueFromSecret

"A reference to a Kubernetes Secret containing the fingerprint."

### fn spec.oracleApiPrivateKeyFingerprint.valueFromSecret.withKey
...
### fn spec.oracleApiPrivateKeyFingerprint.valueFromSecret.withName
...
## obj spec.oracleApiPrivateKeyPassphrase

"Passphrase to unlock the 'oracleApiPrivateKey'."

### fn spec.oracleApiPrivateKeyPassphrase.withValue

```ts
withValue(value)
```

"Literal value of the passphrase."

## obj spec.oracleApiPrivateKeyPassphrase.valueFromSecret

"A reference to a Kubernetes Secret containing the passphrase."

### fn spec.oracleApiPrivateKeyPassphrase.valueFromSecret.withKey
...
### fn spec.oracleApiPrivateKeyPassphrase.valueFromSecret.withName
...
"The destination of events sourced from OCI metrics."
