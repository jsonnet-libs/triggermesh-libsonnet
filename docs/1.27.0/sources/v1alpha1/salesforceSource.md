---
permalink: /1.27.0/sources/v1alpha1/salesforceSource/
---

# sources.v1alpha1.salesforceSource

"TriggerMesh event source for Salesforce."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.auth`](#obj-specauth)
    * [`fn withClientID(clientID)`](#fn-specauthwithclientid)
    * [`fn withServer(server)`](#fn-specauthwithserver)
    * [`fn withUser(user)`](#fn-specauthwithuser)
    * [`obj spec.auth.certKey`](#obj-specauthcertkey)
      * [`fn withValue(value)`](#fn-specauthcertkeywithvalue)
      * [`obj spec.auth.certKey.valueFromSecret`](#obj-specauthcertkeyvaluefromsecret)
        * [`fn withKey(key)`](#fn-specauthcertkeyvaluefromsecretwithkey)
        * [`fn withName(name)`](#fn-specauthcertkeyvaluefromsecretwithname)
  ...
  * [`obj spec.subscription`](#obj-specsubscription)
    * [`fn withChannel(channel)`](#fn-specsubscriptionwithchannel)
    * [`fn withReplayID(replayID)`](#fn-specsubscriptionwithreplayid)
...
new returns an instance of SalesforceSource
...
## obj spec.auth.certKey

"Certificate key to sign authentication requests with the Salesforce API."

### fn spec.auth.certKey.withValue

```ts
withValue(value)
```

"Literal value of the certificate key."

## obj spec.auth.certKey.valueFromSecret

"A reference to a Kubernetes Secret containing the certificate key."

### fn spec.auth.certKey.valueFromSecret.withKey
...
### fn spec.auth.certKey.valueFromSecret.withName
...
"The destination of events received via Salesforce streams."
...
### fn spec.subscription.withChannel
...
### fn spec.subscription.withReplayID
