---
permalink: /1.27.0/sources/v1alpha1/slackSource/
---

# sources.v1alpha1.slackSource

"TriggerMesh event source for Slack."
...
* [`obj spec`](#obj-spec)
  * [`fn withAppID(appID)`](#fn-specwithappid)
  ...
  * [`obj spec.signingSecret`](#obj-specsigningsecret)
    * [`fn withValue(value)`](#fn-specsigningsecretwithvalue)
    * [`obj spec.signingSecret.valueFromSecret`](#obj-specsigningsecretvaluefromsecret)
      * [`fn withKey(key)`](#fn-specsigningsecretvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specsigningsecretvaluefromsecretwithname)
...
new returns an instance of SlackSource
...
"ID which identifies the Slack application generating this event. It helps identifying the App that sources events when multiple Slack applications share the same endpoint."
...
## obj spec.signingSecret

"Signing secret to authenticate Slack callbacks."

### fn spec.signingSecret.withValue

```ts
withValue(value)
```

"Literal value of the signing secret."

## obj spec.signingSecret.valueFromSecret

"A reference to a Kubernetes Secret containing the signing secret."

### fn spec.signingSecret.valueFromSecret.withKey
...
### fn spec.signingSecret.valueFromSecret.withName
...
"The destination of events generated from Slack callbacks."
