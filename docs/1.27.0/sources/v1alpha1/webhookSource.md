---
permalink: /1.27.0/sources/v1alpha1/webhookSource/
---

# sources.v1alpha1.webhookSource

"TriggerMesh event source for receiving arbitrary events over a HTTP/S webhook."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withCorsAllowOrigin(corsAllowOrigin)`](#fn-specwithcorsalloworigin)
  * [`fn withEventSource(eventSource)`](#fn-specwitheventsource)
  * [`fn withEventType(eventType)`](#fn-specwitheventtype)
  ...
  * [`obj spec.basicAuthPassword`](#obj-specbasicauthpassword)
    * [`fn withValue(value)`](#fn-specbasicauthpasswordwithvalue)
    * [`obj spec.basicAuthPassword.valueFromSecret`](#obj-specbasicauthpasswordvaluefromsecret)
      * [`fn withKey(key)`](#fn-specbasicauthpasswordvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specbasicauthpasswordvaluefromsecretwithname)
  * [`obj spec.eventExtensionAttributes`](#obj-speceventextensionattributes)
    * [`fn withFrom(from)`](#fn-speceventextensionattributeswithfrom)
    * [`fn withFromMixin(from)`](#fn-speceventextensionattributeswithfrommixin)
...
new returns an instance of WebhookSource
...
### fn spec.withCorsAllowOrigin

```ts
withCorsAllowOrigin(corsAllowOrigin)
```

"Value of the CORS 'Access-Control-Allow-Origin' header to set on ingested requests."

### fn spec.withEventSource

```ts
withEventSource(eventSource)
```

"Value of the CloudEvents 'source' attribute to set on ingested events. Identifies the context in which an event happened. Must be expressed as a URI-reference. Please refer to the CloudEvents specification for more details: https://github.com/cloudevents/spec/blob/v1.0.1/spec.md#source-1"

### fn spec.withEventType

```ts
withEventType(eventType)
```

"Value of the CloudEvents 'type' attribute to set on ingested events. Describes the type of event related to the originating occurrence. Please refer to the CloudEvents specification for more details: https://github.com/cloudevents/spec/blob/v1.0.1/spec.md#type"
...
### fn spec.basicAuthPassword.withValue

```ts
withValue(value)
```

"Literal value of the password."

## obj spec.basicAuthPassword.valueFromSecret

"A reference to a Kubernetes Secret object containing the password."

### fn spec.basicAuthPassword.valueFromSecret.withKey

```ts
withKey(key)
```

"Key from the Secret object."

### fn spec.basicAuthPassword.valueFromSecret.withName
...
## obj spec.eventExtensionAttributes

"CloudEvents extension attributes to be added based on HTTP request fields."

### fn spec.eventExtensionAttributes.withFrom

```ts
withFrom(from)
```

"Source elements to create attributes from. Elements that might contain multiple values (headers, queries) will convert all of them into extension attributes"

### fn spec.eventExtensionAttributes.withFromMixin
...
"The destination of events generated from requests to the webhook."
