---
permalink: /1.27.0/sources/v1alpha1/zendeskSource/
---

# sources.v1alpha1.zendeskSource

"TriggerMesh event source for Zendesk."
...
* [`obj spec`](#obj-spec)
  * [`fn withEmail(email)`](#fn-specwithemail)
  * [`fn withSubdomain(subdomain)`](#fn-specwithsubdomain)
  * [`fn withWebhookUsername(webhookUsername)`](#fn-specwithwebhookusername)
  ...
  * [`obj spec.token`](#obj-spectoken)
    * [`fn withValue(value)`](#fn-spectokenwithvalue)
    * [`obj spec.token.valueFromSecret`](#obj-spectokenvaluefromsecret)
      * [`fn withKey(key)`](#fn-spectokenvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-spectokenvaluefromsecretwithname)
  * [`obj spec.webhookPassword`](#obj-specwebhookpassword)
    * [`fn withValue(value)`](#fn-specwebhookpasswordwithvalue)
    * [`obj spec.webhookPassword.valueFromSecret`](#obj-specwebhookpasswordvaluefromsecret)
      * [`fn withKey(key)`](#fn-specwebhookpasswordvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specwebhookpasswordvaluefromsecretwithname)
...
new returns an instance of ZendeskSource
...
### fn spec.withWebhookUsername

```ts
withWebhookUsername(webhookUsername)
```

"User name Zendesk requests must set to authenticate with the webhook using HTTP Basic authentication."
...
### fn spec.token.withValue

```ts
withValue(value)
```

"Literal value of the API token."

## obj spec.token.valueFromSecret

"A reference to a Kubernetes Secret containing the API token."

### fn spec.token.valueFromSecret.withKey
...
### fn spec.token.valueFromSecret.withName
...
## obj spec.webhookPassword

"Password Zendesk requests must set to authenticate with the webhook using HTTP Basic authentication."

### fn spec.webhookPassword.withValue
...
## obj spec.webhookPassword.valueFromSecret

"A reference to a Kubernetes Secret object containing the password."

### fn spec.webhookPassword.valueFromSecret.withKey
...
### fn spec.webhookPassword.valueFromSecret.withName
