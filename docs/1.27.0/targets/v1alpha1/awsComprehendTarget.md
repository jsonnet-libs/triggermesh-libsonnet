---
permalink: /1.27.0/targets/v1alpha1/awsComprehendTarget/
---

# targets.v1alpha1.awsComprehendTarget

"An event targte for sending messages to the AWS Comprehend API."
...
new returns an instance of AWSComprehendTarget
...
"Language code to use for Comprehend. Available languages can be found at https://docs.aws.amazon.com/comprehend/latest/dg/supported-languages.html."
...
"Code of the AWS region to use for the Comprehend API. Available region codes are documented in the AWS General Reference at https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints."
