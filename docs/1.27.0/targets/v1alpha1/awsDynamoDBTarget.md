---
permalink: /1.27.0/targets/v1alpha1/awsDynamoDBTarget/
---

# targets.v1alpha1.awsDynamoDBTarget

"TriggerMesh event target for AWS DynamoDB."
...
new returns an instance of AWSDynamoDBTarget
...
"ARN of the DynamoDB table to post events to. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazondynamodb.html"
