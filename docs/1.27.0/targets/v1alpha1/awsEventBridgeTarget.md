---
permalink: /1.27.0/targets/v1alpha1/awsEventBridgeTarget/
---

# targets.v1alpha1.awsEventBridgeTarget

"TriggerMesh event target for AWS EventBridge Service."
...
new returns an instance of AWSEventBridgeTarget
...
"ARN of the Event Bus that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoneventbridge.html"
...
"Whether to omit CloudEvent context attributes in messages sent to EventBridge. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."
...
"Authentication method to interact with the Amazon API."
