---
permalink: /1.27.0/targets/v1alpha1/awsKinesisTarget/
---

# targets.v1alpha1.awsKinesisTarget

"An event target that can stream events into an AWS Kinesis stream."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPartition(partition)`](#fn-specwithpartition)
...
new returns an instance of AWSKinesisTarget
...
"ARN of the Kinesis stream that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonkinesis.html"
...
### fn spec.withPartition

```ts
withPartition(partition)
```

"A Kinesis partition name is required for the target to know where to stream the events to."
