---
permalink: /1.27.0/targets/v1alpha1/awsLambdaTarget/
---

# targets.v1alpha1.awsLambdaTarget

"TriggerMesh event target for AWS Lambda."
...
new returns an instance of AWSLambdaTarget
...
"ARN of the Lambda function that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_awslambda.html"
