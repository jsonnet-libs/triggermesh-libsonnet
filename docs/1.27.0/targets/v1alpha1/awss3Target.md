---
permalink: /1.27.0/targets/v1alpha1/awss3Target/
---

# targets.v1alpha1.awss3Target

"An event target that can stream events into an AWS S3 bucket."
...
new returns an instance of AWSS3Target
...
"ARN of the S3 bucket that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html"
