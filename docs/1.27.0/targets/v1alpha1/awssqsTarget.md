---
permalink: /1.27.0/targets/v1alpha1/awssqsTarget/
---

# targets.v1alpha1.awssqsTarget

"TriggerMesh event target for AWS Simple Queue Service."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMessageGroupId(messageGroupId)`](#fn-specwithmessagegroupid)
...
new returns an instance of AWSSQSTarget
...
"ARN of the SQS queue that will receive events. The expected format is documented at https://docs.aws.amazon.com/service-authorization/latest/reference/list_awslambda.html"
...
### fn spec.withMessageGroupId

```ts
withMessageGroupId(messageGroupId)
```

"FIFO queue grouping to ensure proper ordering. Should be unique per target"
