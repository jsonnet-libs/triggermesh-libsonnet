---
permalink: /1.27.0/targets/v1alpha1/azureEventHubsTarget/
---

# targets.v1alpha1.azureEventHubsTarget

"TriggerMesh event target for Azure Event Hubs."
...
new returns an instance of AzureEventHubsTarget
...
"Whether to omit CloudEvent context attributes in objects created in Azure Event Hub. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."
