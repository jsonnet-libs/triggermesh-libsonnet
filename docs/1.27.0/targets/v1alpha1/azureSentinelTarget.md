---
permalink: /1.27.0/targets/v1alpha1/azureSentinelTarget/
---

# targets.v1alpha1.azureSentinelTarget

"TriggerMesh event target for azuresentineltarget."
...
* [`obj spec`](#obj-spec)
  * [`fn withResourceGroup(resourceGroup)`](#fn-specwithresourcegroup)
  * [`fn withSubscriptionID(subscriptionID)`](#fn-specwithsubscriptionid)
  * [`fn withWorkspace(workspace)`](#fn-specwithworkspace)
...
new returns an instance of AzureSentinelTarget
...
"Authentication method to interact with the Azure Event Hubs REST API."
