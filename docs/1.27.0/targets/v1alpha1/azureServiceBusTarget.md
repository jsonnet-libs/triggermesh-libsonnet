---
permalink: /1.27.0/targets/v1alpha1/azureServiceBusTarget/
---

# targets.v1alpha1.azureServiceBusTarget

"TriggerMesh event target for Azure Service Bus."
...
new returns an instance of AzureServiceBusTarget
...
"Whether to omit CloudEvent context attributes in objects created in Azure Service Bus. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."
...
"Authentication method to interact with the Azure Service Bus REST API."
...
"Connection string containing both the resource URI of the Service Bus instance, and the SAS token. Mutually exclusive with 'keyName' and 'keyValue'."
