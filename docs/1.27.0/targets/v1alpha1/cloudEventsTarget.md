---
permalink: /1.27.0/targets/v1alpha1/cloudEventsTarget/
---

# targets.v1alpha1.cloudEventsTarget

"TriggerMesh event target that acts as a gateway for outgoing CloudEvents."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.credentials`](#obj-speccredentials)
    * [`obj spec.credentials.basicAuth`](#obj-speccredentialsbasicauth)
      * [`fn withUsername(username)`](#fn-speccredentialsbasicauthwithusername)
      * [`obj spec.credentials.basicAuth.password`](#obj-speccredentialsbasicauthpassword)
        * [`obj spec.credentials.basicAuth.password.valueFromSecret`](#obj-speccredentialsbasicauthpasswordvaluefromsecret)
          * [`fn withKey(key)`](#fn-speccredentialsbasicauthpasswordvaluefromsecretwithkey)
          * [`fn withName(name)`](#fn-speccredentialsbasicauthpasswordvaluefromsecretwithname)
...
new returns an instance of CloudEventsTarget
...
"An HTTP CloudEvents endpoint to stream events to."
...
"Optional credentials specification for remote CloudEvents endpoint."

## obj spec.credentials.basicAuth

"HTTP basic authentication parameters."

### fn spec.credentials.basicAuth.withUsername
...
## obj spec.credentials.basicAuth.password

"Password for HTTP Basic authentication."

## obj spec.credentials.basicAuth.password.valueFromSecret

"A reference to a Kubernetes Secret object containing the password."

### fn spec.credentials.basicAuth.password.valueFromSecret.withKey
...
### fn spec.credentials.basicAuth.password.valueFromSecret.withName
