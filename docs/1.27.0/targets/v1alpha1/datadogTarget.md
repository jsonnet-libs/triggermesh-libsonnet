---
permalink: /1.27.0/targets/v1alpha1/datadogTarget/
---

# targets.v1alpha1.datadogTarget

"TriggerMesh event target for Datadog."
...
new returns an instance of DatadogTarget
...
"Controls the site of the Datadog intake API"
...
"Datadog API Key with access to receive metrics."
