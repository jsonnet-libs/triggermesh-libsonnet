---
permalink: /1.27.0/targets/v1alpha1/elasticsearchTarget/
---

# targets.v1alpha1.elasticsearchTarget

"TriggerMesh event target for Elasticsearch."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withIndexName(indexName)`](#fn-specwithindexname)
  ...
  * [`obj spec.connection`](#obj-specconnection)
    * [`fn withAddresses(addresses)`](#fn-specconnectionwithaddresses)
    * [`fn withAddressesMixin(addresses)`](#fn-specconnectionwithaddressesmixin)
    * [`fn withSkipVerify(skipVerify)`](#fn-specconnectionwithskipverify)
    * [`fn withUsername(username)`](#fn-specconnectionwithusername)
    * [`obj spec.connection.apiKey`](#obj-specconnectionapikey)
      * [`obj spec.connection.apiKey.secretKeyRef`](#obj-specconnectionapikeysecretkeyref)
        * [`fn withKey(key)`](#fn-specconnectionapikeysecretkeyrefwithkey)
        * [`fn withName(name)`](#fn-specconnectionapikeysecretkeyrefwithname)
    * [`obj spec.connection.password`](#obj-specconnectionpassword)
      * [`obj spec.connection.password.secretKeyRef`](#obj-specconnectionpasswordsecretkeyref)
        * [`fn withKey(key)`](#fn-specconnectionpasswordsecretkeyrefwithkey)
        * [`fn withName(name)`](#fn-specconnectionpasswordsecretkeyrefwithname)
...
new returns an instance of ElasticsearchTarget
...
### fn spec.withIndexName

```ts
withIndexName(indexName)
```

"Elasticsearch index to stream the events to."
...
"Attributes for connecting to a private Elasticsearch instance or Elastic cloud."

### fn spec.connection.withAddresses

```ts
withAddresses(addresses)
```

"Hostname/IP Address of the Elasticsearch instance to stream events to."

### fn spec.connection.withAddressesMixin
...
### fn spec.connection.withSkipVerify

```ts
withSkipVerify(skipVerify)
```

"Skip verification of SSL/TLS certificates."

### fn spec.connection.withUsername
...
## obj spec.connection.apiKey

"API Key to connect to the Elasticsearch instance."

## obj spec.connection.apiKey.secretKeyRef



### fn spec.connection.apiKey.secretKeyRef.withKey
...
### fn spec.connection.apiKey.secretKeyRef.withName
...
## obj spec.connection.password

"Elasticsearch instance password."

## obj spec.connection.password.secretKeyRef



### fn spec.connection.password.secretKeyRef.withKey
...
### fn spec.connection.password.secretKeyRef.withName
