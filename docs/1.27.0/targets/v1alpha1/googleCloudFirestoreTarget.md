---
permalink: /1.27.0/targets/v1alpha1/googleCloudFirestoreTarget/
---

# targets.v1alpha1.googleCloudFirestoreTarget

"TriggerMesh event target for Google Cloud Firestore."
...
* [`obj spec`](#obj-spec)
  * [`fn withDefaultCollection(defaultCollection)`](#fn-specwithdefaultcollection)
  ...
  * [`obj spec.credentialsJson`](#obj-speccredentialsjson)
    * [`obj spec.credentialsJson.secretKeyRef`](#obj-speccredentialsjsonsecretkeyref)
      * [`fn withKey(key)`](#fn-speccredentialsjsonsecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-speccredentialsjsonsecretkeyrefwithname)
...
new returns an instance of GoogleCloudFirestoreTarget
...
### fn spec.withDefaultCollection

```ts
withDefaultCollection(defaultCollection)
```

"Default firestore collection to stream events into."
...
"Whether to omit CloudEvent context attributes in documents created in Firestore. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included. component only."
...
"Google Cloud Project ID associated with the firestore database."
...
## obj spec.credentialsJson

"Deprecated, please use spec.auth.serviceAccountKey object."

## obj spec.credentialsJson.secretKeyRef



### fn spec.credentialsJson.secretKeyRef.withKey
...
### fn spec.credentialsJson.secretKeyRef.withName
