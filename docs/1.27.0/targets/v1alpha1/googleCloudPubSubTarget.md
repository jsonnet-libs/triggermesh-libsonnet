---
permalink: /1.27.0/targets/v1alpha1/googleCloudPubSubTarget/
---

# targets.v1alpha1.googleCloudPubSubTarget

"TriggerMesh event target for Google Cloud Pub/Sub."
...
new returns an instance of GoogleCloudPubSubTarget
...
"Full resource name of the Pub/Sub topic to stream events to, in the format \"projects/{project_name}/topics/{topic_name}\"."
