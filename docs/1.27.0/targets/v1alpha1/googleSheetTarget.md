---
permalink: /1.27.0/targets/v1alpha1/googleSheetTarget/
---

# targets.v1alpha1.googleSheetTarget

"TriggerMesh event target for appending or updating a Googlesheet."
...
* [`obj spec`](#obj-spec)
  * [`fn withDefaultPrefix(defaultPrefix)`](#fn-specwithdefaultprefix)
  ...
  * [`obj spec.googleServiceAccount`](#obj-specgoogleserviceaccount)
    * [`obj spec.googleServiceAccount.secretKeyRef`](#obj-specgoogleserviceaccountsecretkeyref)
      * [`fn withKey(key)`](#fn-specgoogleserviceaccountsecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specgoogleserviceaccountsecretkeyrefwithname)
...
new returns an instance of GoogleSheetTarget
...
### fn spec.withDefaultPrefix

```ts
withDefaultPrefix(defaultPrefix)
```

"A prefix to be used when creating a new sheet inside a document."
...
"Googlesheet ID associated with the document being targeted."
...
## obj spec.googleServiceAccount

"Deprecated, please use spec.auth.serviceAccountKey object."

## obj spec.googleServiceAccount.secretKeyRef



### fn spec.googleServiceAccount.secretKeyRef.withKey
...
### fn spec.googleServiceAccount.secretKeyRef.withName
