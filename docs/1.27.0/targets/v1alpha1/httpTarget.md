---
permalink: /1.27.0/targets/v1alpha1/httpTarget/
---

# targets.v1alpha1.httpTarget

"TriggerMesh event target for generic HTTP endpoints."
...
* [`obj spec`](#obj-spec)
  * [`fn withBasicAuthUsername(basicAuthUsername)`](#fn-specwithbasicauthusername)
  * [`fn withCaCertificate(caCertificate)`](#fn-specwithcacertificate)
  ...
  * [`fn withOauthClientID(oauthClientID)`](#fn-specwithoauthclientid)
  * [`fn withOauthScopes(oauthScopes)`](#fn-specwithoauthscopes)
  * [`fn withOauthScopesMixin(oauthScopes)`](#fn-specwithoauthscopesmixin)
  * [`fn withOauthTokenURL(oauthTokenURL)`](#fn-specwithoauthtokenurl)
  * [`fn withSkipVerify(skipVerify)`](#fn-specwithskipverify)
  ...
  * [`obj spec.basicAuthPassword`](#obj-specbasicauthpassword)
    * [`obj spec.basicAuthPassword.secretKeyRef`](#obj-specbasicauthpasswordsecretkeyref)
      * [`fn withKey(key)`](#fn-specbasicauthpasswordsecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specbasicauthpasswordsecretkeyrefwithname)
  * [`obj spec.oauthClientSecret`](#obj-specoauthclientsecret)
    * [`obj spec.oauthClientSecret.secretKeyRef`](#obj-specoauthclientsecretsecretkeyref)
      * [`fn withKey(key)`](#fn-specoauthclientsecretsecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specoauthclientsecretsecretkeyrefwithname)
  * [`obj spec.response`](#obj-specresponse)
    * [`fn withEventSource(eventSource)`](#fn-specresponsewitheventsource)
    * [`fn withEventType(eventType)`](#fn-specresponsewitheventtype)
...
new returns an instance of HTTPTarget
...
### fn spec.withBasicAuthUsername

```ts
withBasicAuthUsername(basicAuthUsername)
```

"When using HTTP Basic authentication, the username to connect to the target service."

### fn spec.withCaCertificate

```ts
withCaCertificate(caCertificate)
```

"The CA certificate used to sign the certificated used by the target server."
...
"An HTTP based REST endpoint to stream events to."
...
"Additional headers required to be set when communicating wiht the target service."
...
### fn spec.withOauthClientID

```ts
withOauthClientID(oauthClientID)
```

"When using OAuth, the client id used to authenticate against the target service."

### fn spec.withOauthScopes

```ts
withOauthScopes(oauthScopes)
```

"When using OAuth, the scopes required by the target to use the service."

### fn spec.withOauthScopesMixin
...
### fn spec.withOauthTokenURL

```ts
withOauthTokenURL(oauthTokenURL)
```

"When using OAuth, the Token URL used to sign the request against."

### fn spec.withSkipVerify

```ts
withSkipVerify(skipVerify)
```

"Skip validation and verification of the SSL/TLS certificate."
...
## obj spec.basicAuthPassword

"When using HTTP Basic authentication, the password to connect to the target service."

## obj spec.basicAuthPassword.secretKeyRef



### fn spec.basicAuthPassword.secretKeyRef.withKey
...
### fn spec.basicAuthPassword.secretKeyRef.withName
...
## obj spec.oauthClientSecret

"When using OAuth, the client secret used to authenticate against the target service"

## obj spec.oauthClientSecret.secretKeyRef



### fn spec.oauthClientSecret.secretKeyRef.withKey
...
### fn spec.oauthClientSecret.secretKeyRef.withName
...
"HTTP target response event attributes."

### fn spec.response.withEventSource

```ts
withEventSource(eventSource)
```

"EventSource is an optional but recommended field for identifying the instance producing the events."

### fn spec.response.withEventType

```ts
withEventType(eventType)
```

"EventType is required to set the Type for the ingested event."