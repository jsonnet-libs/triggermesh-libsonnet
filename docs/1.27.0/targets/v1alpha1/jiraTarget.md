---
permalink: /1.27.0/targets/v1alpha1/jiraTarget/
---

# targets.v1alpha1.jiraTarget

"TriggerMesh event target for Jira."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.auth`](#obj-specauth)
    ...
    * [`obj spec.auth.token`](#obj-specauthtoken)
      * [`obj spec.auth.token.secretKeyRef`](#obj-specauthtokensecretkeyref)
        * [`fn withKey(key)`](#fn-specauthtokensecretkeyrefwithkey)
        * [`fn withName(name)`](#fn-specauthtokensecretkeyrefwithname)
...
new returns an instance of JiraTarget
...
"Credentials to authenticate against the Jira instance."
...
"Jira username for the target to use."

## obj spec.auth.token

"Jira API token associated with the Jira user."

## obj spec.auth.token.secretKeyRef



### fn spec.auth.token.secretKeyRef.withKey
...
### fn spec.auth.token.secretKeyRef.withName
