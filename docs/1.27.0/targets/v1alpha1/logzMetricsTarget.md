---
permalink: /1.27.0/targets/v1alpha1/logzMetricsTarget/
---

# targets.v1alpha1.logzMetricsTarget

"The OpenTelemetry metrics target pushes metrics to a range of backends."
...
* [`obj spec`](#obj-spec)
  * [`fn withInstruments(instruments)`](#fn-specwithinstruments)
  * [`fn withInstrumentsMixin(instruments)`](#fn-specwithinstrumentsmixin)
  ...
  * [`obj spec.connection`](#obj-specconnection)
    * [`fn withListenerURL(listenerURL)`](#fn-specconnectionwithlistenerurl)
    * [`obj spec.connection.token`](#obj-specconnectiontoken)
      * [`obj spec.connection.token.secretKeyRef`](#obj-specconnectiontokensecretkeyref)
        * [`fn withKey(key)`](#fn-specconnectiontokensecretkeyrefwithkey)
        * [`fn withName(name)`](#fn-specconnectiontokensecretkeyrefwithname)
  * [`obj spec.eventOptions`](#obj-speceventoptions)
    * [`fn withPayloadPolicy(payloadPolicy)`](#fn-speceventoptionswithpayloadpolicy)
  * [`obj spec.instruments`](#obj-specinstruments)
    * [`fn withDescription(description)`](#fn-specinstrumentswithdescription)
    * [`fn withInstrument(instrument)`](#fn-specinstrumentswithinstrument)
    * [`fn withName(name)`](#fn-specinstrumentswithname)
    * [`fn withNumber(number)`](#fn-specinstrumentswithnumber)
...
new returns an instance of LogzMetricsTarget
...
### fn spec.withInstrumentsMixin

```ts
withInstrumentsMixin(instruments)
```
...
### fn spec.connection.withListenerURL

```ts
withListenerURL(listenerURL)
```

"Listener URL for pushing metrics."

## obj spec.connection.token

"Token for connecting to Logz metrics listener."

## obj spec.connection.token.secretKeyRef



### fn spec.connection.token.secretKeyRef.withKey
...
### fn spec.connection.token.secretKeyRef.withName
...
### fn spec.instruments.withInstrument
...
### fn spec.instruments.withNumber
