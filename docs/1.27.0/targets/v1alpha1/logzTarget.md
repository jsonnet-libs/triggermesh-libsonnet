---
permalink: /1.27.0/targets/v1alpha1/logzTarget/
---

# targets.v1alpha1.logzTarget

"TriggerMesh event target for Logz."
...
* [`obj spec`](#obj-spec)
  * [`fn withLogsListenerURL(logsListenerURL)`](#fn-specwithlogslistenerurl)
  ...
  * [`obj spec.shippingToken`](#obj-specshippingtoken)
    * [`obj spec.shippingToken.secretKeyRef`](#obj-specshippingtokensecretkeyref)
      * [`fn withKey(key)`](#fn-specshippingtokensecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specshippingtokensecretkeyrefwithname)
...
new returns an instance of LogzTarget
...
### fn spec.withLogsListenerURL

```ts
withLogsListenerURL(logsListenerURL)
```

"Logz listener host to stream events to."
...
## obj spec.shippingToken

"API token used to authenticate the event being streamed."

## obj spec.shippingToken.secretKeyRef



### fn spec.shippingToken.secretKeyRef.withKey
...
### fn spec.shippingToken.secretKeyRef.withName
