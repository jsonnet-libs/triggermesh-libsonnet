---
permalink: /1.27.0/targets/v1alpha1/mongoDBTarget/
---

# targets.v1alpha1.mongoDBTarget

"TriggerMesh event target for MongoDB."
...
* [`obj spec`](#obj-spec)
  * [`fn withCollection(collection)`](#fn-specwithcollection)
  * [`fn withDatabase(database)`](#fn-specwithdatabase)
  ...
  * [`obj spec.connectionString`](#obj-specconnectionstring)
    * [`fn withValue(value)`](#fn-specconnectionstringwithvalue)
    * [`obj spec.connectionString.valueFromSecret`](#obj-specconnectionstringvaluefromsecret)
      * [`fn withKey(key)`](#fn-specconnectionstringvaluefromsecretwithkey)
      * [`fn withName(name)`](#fn-specconnectionstringvaluefromsecretwithname)
...
new returns an instance of MongoDBTarget
...
### fn spec.withCollection

```ts
withCollection(collection)
```

"Define the default (over-writeable at runtime) collection to write new events to."
...
"Define the default (over-writeable at runtime) database to write new events to."
...
## obj spec.connectionString

"The connection string containing the endpoint for the MongoDB Server and the Username + Password to connect with the instance. EX. mongodb+srv://<user>:<password>@<database_url>/?retryWrites=true&w=majority."

### fn spec.connectionString.withValue
...
## obj spec.connectionString.valueFromSecret

"A reference to a Kubernetes Secret object containing the connection string."

### fn spec.connectionString.valueFromSecret.withKey
...
### fn spec.connectionString.valueFromSecret.withName
