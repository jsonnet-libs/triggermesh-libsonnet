---
permalink: /1.27.0/targets/v1alpha1/oracleTarget/
---

# targets.v1alpha1.oracleTarget

"TriggerMesh event target for Oracle Cloud (OCI)."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.function`](#obj-specfunction)
    * [`fn withFunction(Function)`](#fn-specfunctionwithfunction)
  * [`obj spec.oracleApiPrivateKey`](#obj-specoracleapiprivatekey)
    * [`obj spec.oracleApiPrivateKey.secretKeyRef`](#obj-specoracleapiprivatekeysecretkeyref)
      * [`fn withKey(key)`](#fn-specoracleapiprivatekeysecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specoracleapiprivatekeysecretkeyrefwithname)
  * [`obj spec.oracleApiPrivateKeyFingerprint`](#obj-specoracleapiprivatekeyfingerprint)
    * [`obj spec.oracleApiPrivateKeyFingerprint.secretKeyRef`](#obj-specoracleapiprivatekeyfingerprintsecretkeyref)
      * [`fn withKey(key)`](#fn-specoracleapiprivatekeyfingerprintsecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specoracleapiprivatekeyfingerprintsecretkeyrefwithname)
  * [`obj spec.oracleApiPrivateKeyPassphrase`](#obj-specoracleapiprivatekeypassphrase)
    * [`obj spec.oracleApiPrivateKeyPassphrase.secretKeyRef`](#obj-specoracleapiprivatekeypassphrasesecretkeyref)
      * [`fn withKey(key)`](#fn-specoracleapiprivatekeypassphrasesecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specoracleapiprivatekeypassphrasesecretkeyrefwithname)
...
new returns an instance of OracleTarget
...
"The Oracle Cloud region containing the service being executed. A full list of supported regions can be found at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm."
...
"The Oracle Cloud ID (OCID) of the tenant containing the service to be used on the Oracle Cloud."
...
"The Oracle Cloud ID (OCID) of the user who owns the key used to interact with the Oracle Cloud."
...
"Invoke a serverless function on the Oracle Cloud."

### fn spec.function.withFunction

```ts
withFunction(Function)
```

"The Oracle Cloud ID (OCID) of the function being invoked."

## obj spec.oracleApiPrivateKey

"Oracle API Private Key to sign each request to the Oracle Cloud. For details on how to create a private keypair for Oracle Cloud, refer to https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm."

## obj spec.oracleApiPrivateKey.secretKeyRef



### fn spec.oracleApiPrivateKey.secretKeyRef.withKey
...
### fn spec.oracleApiPrivateKey.secretKeyRef.withName
...
"MD5 fingerprint to identify the keypair associated with the key used to sign each request to the Oracle Cloud. For details on how to create a private keypair for Oracle Cloud, refer to https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm."

## obj spec.oracleApiPrivateKeyFingerprint.secretKeyRef



### fn spec.oracleApiPrivateKeyFingerprint.secretKeyRef.withKey
...
### fn spec.oracleApiPrivateKeyFingerprint.secretKeyRef.withName
...
"Passphrase to unlock the private key used to sign each request to the Oracle Cloud. For details on how to create a private keypair for Oracle Cloud, refer to https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm."

## obj spec.oracleApiPrivateKeyPassphrase.secretKeyRef



### fn spec.oracleApiPrivateKeyPassphrase.secretKeyRef.withKey
...
### fn spec.oracleApiPrivateKeyPassphrase.secretKeyRef.withName
