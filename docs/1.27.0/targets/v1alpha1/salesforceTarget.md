---
permalink: /1.27.0/targets/v1alpha1/salesforceTarget/
---

# targets.v1alpha1.salesforceTarget

"TriggerMesh event target for Salesforce."
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.auth`](#obj-specauth)
    ...
    * [`obj spec.auth.certKey`](#obj-specauthcertkey)
      * [`obj spec.auth.certKey.secretKeyRef`](#obj-specauthcertkeysecretkeyref)
        * [`fn withKey(key)`](#fn-specauthcertkeysecretkeyrefwithkey)
        * [`fn withName(name)`](#fn-specauthcertkeysecretkeyrefwithname)
...
new returns an instance of SalesforceTarget
...
"Salesforce API version to use for the target's integration with Salesforce."
...
"Attributes required to setup OAuth authentication with Salesforce. To create the credentials, refer to https://help.salesforce.com/articleView?id=sf.remoteaccess_oauth_jwt_flow.htm."
...
"OAuth Client ID used to identify the target."
...
"The Salesforce authentication URL associated with the instance being used."
...
"Salesforce requires a certificate to facilitate the authentication flow."

## obj spec.auth.certKey.secretKeyRef



### fn spec.auth.certKey.secretKeyRef.withKey
...
### fn spec.auth.certKey.secretKeyRef.withName
