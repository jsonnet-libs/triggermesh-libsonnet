---
permalink: /1.27.0/targets/v1alpha1/sendGridTarget/
---

# targets.v1alpha1.sendGridTarget

"TriggerMesh event target for Sendgrid."
...
* [`obj spec`](#obj-spec)
  * [`fn withDefaultFromEmail(defaultFromEmail)`](#fn-specwithdefaultfromemail)
  * [`fn withDefaultFromName(defaultFromName)`](#fn-specwithdefaultfromname)
  * [`fn withDefaultMessage(defaultMessage)`](#fn-specwithdefaultmessage)
  * [`fn withDefaultSubject(defaultSubject)`](#fn-specwithdefaultsubject)
  * [`fn withDefaultToEmail(defaultToEmail)`](#fn-specwithdefaulttoemail)
  * [`fn withDefaultToName(defaultToName)`](#fn-specwithdefaulttoname)
  ...
  * [`obj spec.apiKey`](#obj-specapikey)
    * [`obj spec.apiKey.secretKeyRef`](#obj-specapikeysecretkeyref)
      * [`fn withKey(key)`](#fn-specapikeysecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specapikeysecretkeyrefwithname)
...
new returns an instance of SendGridTarget
...
### fn spec.withDefaultFromEmail

```ts
withDefaultFromEmail(defaultFromEmail)
```

"Default sender email address for sending mail via Sendgrid."

### fn spec.withDefaultFromName

```ts
withDefaultFromName(defaultFromName)
```

"Default name to use for the from field when sending email via Sendgrid."

### fn spec.withDefaultMessage

```ts
withDefaultMessage(defaultMessage)
```

"Default message to use for all email sent via this target."

### fn spec.withDefaultSubject

```ts
withDefaultSubject(defaultSubject)
```

"Default subject to use for email sent via this target"

### fn spec.withDefaultToEmail

```ts
withDefaultToEmail(defaultToEmail)
```

"Default email address to send mail to via Sendgrid."

### fn spec.withDefaultToName

```ts
withDefaultToName(defaultToName)
```

"Default name to use for the to field when sending email via Sendgrid."
...
"The Sendgrid API key used to authenticate access."

## obj spec.apiKey.secretKeyRef



### fn spec.apiKey.secretKeyRef.withKey
...
### fn spec.apiKey.secretKeyRef.withName
