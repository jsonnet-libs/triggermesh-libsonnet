---
permalink: /1.27.0/targets/v1alpha1/slackTarget/
---

# targets.v1alpha1.slackTarget

"TriggerMesh event target for Slack Web API."
...
new returns an instance of SlackTarget
...
"Slack API token used to interface with Slack. Consult the Slack API documenation for details on how to setup an app for the target https://api.slack.com/web#authentication."
