---
permalink: /1.27.0/targets/v1alpha1/solaceTarget/
---

# targets.v1alpha1.solaceTarget

"TriggerMesh event target for Solace."
...
new returns an instance of SolaceTarget
...
"Whether to omit CloudEvent context attributes in messages sent to Solace. When this property is false (default), the entire CloudEvent payload is included. When this property is true, only the CloudEvent data is included."
...
"Queue name to stream the target events to."
...
"Solace server used to bootstrap the connection."
...
"Authentication method used to interact with Solace."
...
"Solace account username."

## obj spec.auth.password

"Solace account password."
...
"TLS Authentication method to interact with Solace."
