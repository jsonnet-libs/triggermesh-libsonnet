---
permalink: /1.27.0/targets/v1alpha1/twilioTarget/
---

# targets.v1alpha1.twilioTarget

"TriggerMesh event target for Twilio."
...
* [`obj spec`](#obj-spec)
  * [`fn withDefaultPhoneFrom(defaultPhoneFrom)`](#fn-specwithdefaultphonefrom)
  * [`fn withDefaultPhoneTo(defaultPhoneTo)`](#fn-specwithdefaultphoneto)
  ...
  * [`obj spec.sid`](#obj-specsid)
    * [`obj spec.sid.secretKeyRef`](#obj-specsidsecretkeyref)
      * [`fn withKey(key)`](#fn-specsidsecretkeyrefwithkey)
      * [`fn withName(name)`](#fn-specsidsecretkeyrefwithname)
...
new returns an instance of TwilioTarget
...
### fn spec.withDefaultPhoneFrom

```ts
withDefaultPhoneFrom(defaultPhoneFrom)
```

"Default phone number to send the message from."

### fn spec.withDefaultPhoneTo

```ts
withDefaultPhoneTo(defaultPhoneTo)
```

"Default phone number to send the message to."
...
"Twilio account service ID (SID)"

## obj spec.sid.secretKeyRef



### fn spec.sid.secretKeyRef.withKey
...
### fn spec.sid.secretKeyRef.withName
