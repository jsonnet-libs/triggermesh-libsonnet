---
permalink: /1.27.0/targets/v1alpha1/zendeskTarget/
---

# targets.v1alpha1.zendeskTarget

"TriggerMesh event target for Zendesk."
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withSubject(subject)`](#fn-specwithsubject)
...
new returns an instance of ZendeskTarget
...
"Default registered email address for interacting with Zendesk."
...
"User's subdomain on zendesk being targeted."
...
"Default subject line to use for tickets created using this target."
...
"Zendesk API token for interacting with Zendesk."
